...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},K={argTypes:u,component:c},r={name:"Simple",render:t=>{const{data:i,activeShape:l}=t;return e.createElement(F,{width:"100%",height:400},e.createElement(c,{...t},e.createElement(p,{data:i,dataKey:"uv",shape:({isActive:d,...s})=>e.createElement(I,{...s,fill:d?l.fill:s.fill})}),e.createElement(D,{defaultIndex:3}),e.createElement(g,null)))},args:{...h(u),data:R,activeShape:{fill:"red"},margin:{top:0,right:0,bottom:0,left:0}}},n={render:t=>e.createElement(c,{...t},e.createElement(p,{data:t.data,dataKey:"uv",nameKey:"name",innerRadius:50,outerRadius:80,cornerRadius:8},e.createElement(C,{position:"center",fill:"#000",fontSize:12,fontWeight:"bold",dy:-7},"Donut"),e.createElement(C,{position:"center",fontSize:12,fontWeight:"bold",dy:8},"Chart"),e.createElement(z,{align:"right",verticalAlign:"middle",layout:"vertical"})),e.createElement(g,null)),args:{...h(u),width:500,height:300,data:R}},o={render:t=>{const i=[{x:{value:1},name:"x1",fill:"blue"},{x:{value:2},name:"x2",fill:"red"},{x:{value:3},name:"x3",fill:"green"}],l=[{y:{value:3},name:"y1",fill:"blue"},{y:{value:2},name:"y2",fill:"red"},{y:{value:1},name:"y3",fill:"green"}],d=a=>(v(a.x),a.x.value),s=a=>(v(a.y),a.y.value),[m,b]=f.useState(!1),[P,y]=f.useState(!0);return e.createElement(e.Fragment,null,e.createElement("button",{type:"button",onClick:()=>{b(!1),y(!0)}},"Use data1"),e.createElement("button",{type:"button",onClick:()=>{b(!0),y(!0)}},"Use data2"),e.createElement("button",{type:"button",onClick:()=>{y(!1)}},"Hide"),e.createElement(c,{...t,data:m?l:i},e.createElement(D,null),e.createElement(z,null),e.createElement(g,null),e.createElement(p,{data:m?l:i,name:"Animated line",hide:!P,type:"monotone",dataKey:m?s:d,stroke:"#8884d8",strokeDasharray:"5 5",label:{fill:"red"},animationDuration:3e3})))},args:{...h(u),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}};var x,T,w;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(w=(T=r.parameters)==null?void 0:T.docs)==null?void 0:w.source}}};var S,E,V;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
...
}`,...(V=(E=n.parameters)==null?void 0:E.docs)==null?void 0:V.source}}};var G,k,A;o.parameters={...o.parameters,docs:{...(G=o.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
    type MockDataType = {
      x?: {
        value: number;
...
}`,...(A=(k=o.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};const M=["API","Donut","ChangingDataKey"],X=Object.freeze(Object.defineProperty({__proto__:null,API:r,ChangingDataKey:o,Donut:n,__namedExportsOrder:M,default:K},Symbol.toStringTag,{value:"Module"}));export{r as A,X as C};
