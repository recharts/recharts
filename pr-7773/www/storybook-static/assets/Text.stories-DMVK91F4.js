import{R as n}from"./iframe-BkVFpUlY.js";import{T as s}from"./Text-BIwedGTb.js";import{S as l}from"./isWellBehavedNumber-CfBMT12P.js";import"./preload-helper-Dp1pzeXC.js";import"./get-C2VjdU0L.js";import"./resolveDefaultProps-BteSFwB2.js";import"./DOMUtils-BcDWMqtm.js";import"./useId-Cugd2wLY.js";import"./useBackwardsCompatibleTheme-bP9OoM6q.js";const o={angle:{description:`Text rotation angle in degrees.
...
Ignored when \`textPath\` is set because the path controls the text's positioning.`,control:{type:"select"},options:["end","middle","start"],table:{type:{summary:'"end" | "middle" | "start"'},category:"General",defaultValue:{summary:"end"}},defaultValue:"end"},width:{description:"When width is specified, the text will automatically wrap by calculating the width of text.\nWhen `textPath` is set, this prop does not wrap or constrain the path text; it only affects scaling when `scaleToFit` is enabled.",table:{type:{summary:"number | string"},category:"General"}}},g={argTypes:o,component:s},e={render:t=>n.createElement(l,{width:500,height:300},n.createElement(s,{...t},t.content)),args:{breakAll:!1,lineHeight:"1em",maxLines:3,scaleToFit:!1,textAnchor:"start",verticalAnchor:"start",angle:0,width:200,y:50,x:50,content:"This is really, really, really, really, really, really, really, really, really long text"}},b=["API"];var a,r,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
...
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};export{e as API,b as __namedExportsOrder,g as default};
