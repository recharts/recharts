...
- If set to a function, the function will be called and should return HTML elements.`,table:{type:{summary:"Function | ReactNode"},category:"General"}},contentStyle:{description:"Styles for the wrapper container.",table:{type:{summary:"React.CSSProperties"},category:"Style",defaultValue:{summary:"{}"}},defaultValue:{}},cursor:{description:`If set false, no cursor will be drawn when tooltip is active.
...
and each of them gets this itemStyle applied.`,table:{type:{summary:"React.CSSProperties"},category:"Style",defaultValue:{summary:"{}"}},defaultValue:{}},labelClassName:{control:{type:"text"},table:{type:{summary:"string"},category:"General"}},labelFormatter:{description:"The formatter function of label in tooltip.",table:{type:{summary:"Function"},category:"General"}},labelStyle:{description:`"Label" is the tooltip title.
Renders once on the top of tooltip and shows categorical axis value.

Even if there are multiple graphical items in the chart, only one label gets rendered.`,table:{type:{summary:"React.CSSProperties"},category:"Style",defaultValue:{summary:"{}"}},defaultValue:{}},offset:{description:`The offset size between the position of tooltip and the mouse cursor position.
