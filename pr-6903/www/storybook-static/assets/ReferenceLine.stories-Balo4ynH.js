import{e}from"./iframe-Bn_7jga7.js";import{g as l}from"./utils-ePvtT4un.js";import{R as o}from"./ReferenceLine-Bvtf4E1n.js";import{R as d}from"./arrayEqualityCheck-CSuBYCWj.js";import{C as m}from"./ComposedChart-3lWxqoA_.js";import{C as c}from"./CartesianGrid-Bjka6DH2.js";import{X as p}from"./XAxis-CkQlFxje.js";import{Y as u}from"./YAxis-C7ibSyRg.js";import{L as h}from"./Line-DpIWCQIN.js";import{R as y}from"./RechartsHookInspector-B4H5Lyo-.js";import{p as f}from"./Page-Cj8EiXz7.js";const i={className:{control:{type:"text"},table:{type:{summary:"string"},category:"Style"}},ifOverflow:{description:"Defines how to draw this component if it falls partly outside the canvas:\n\n- `discard`: the whole component will not be drawn at all\n- `hidden`: the component will be clipped to the chart plot area\n- `visible`: the component will be drawn completely\n- `extendDomain`: the domain of the overflown axis will be extended such that the whole component fits into the plot area",table:{type:{summary:'"discard" | "extendDomain" | "hidden" | "visible"'},category:"General",defaultValue:{summary:"discard"}},defaultValue:"discard"},label:{description:"Renders a single label.\n\n- `false`: no labels are rendered\n- `string` | `number`: the content of the label\n- `object`: the props of LabelList component\n- `ReactElement`: a custom label element\n- `function`: a render function of custom label",table:{type:{summary:"(union of 7 variants)"},category:"General",defaultValue:{summary:"false"}},defaultValue:!1},position:{description:`The position of the reference line when the axis has bandwidth
