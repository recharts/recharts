import{e}from"./iframe-DCqI0XZE.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-BQWkPeDZ.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-HdHL-45a.js";import{B as a}from"./Bar-CBMJ9Mmo.js";import{L as d}from"./Line-BIfiJ6dH.js";import{R as D}from"./arrayEqualityCheck-HYppUqbL.js";import{R}from"./RechartsHookInspector-fFyRgJJZ.js";import{X as u}from"./XAxis-v6adQsXq.js";import{Y as y}from"./YAxis-B8A2N8DW.js";import{L as h}from"./Legend-yrJaD9yi.js";import{C as f}from"./CartesianGrid-DdImbUj4.js";import{R as j}from"./ReferenceLine-BxFkQCn5.js";import{R as H}from"./ReferenceDot-59tfjSXO.js";import{B as I}from"./Brush-D_fC1D_4.js";import{L as X}from"./LineChart-DX2lzeAm.js";import{T as g}from"./Tooltip-Cw_iCuSj.js";import{S as Y}from"./Scatter-TAmDX1qH.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
