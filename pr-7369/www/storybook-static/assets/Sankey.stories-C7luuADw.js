import{b as we,u as h,g as xe,s as Le,m as Ne,e as f}from"./iframe-D8sYifa2.js";import{g as O}from"./utils-ePvtT4un.js";import{m as Ve}from"./maxBy-DSSErlNM.js";import{e as Te}from"./iteratee-DhisUvfr.js";import{c as Ie,b as Me,aa as Re,a8 as je,E as te,S as Pe,B as N,a5 as pe,d as Y}from"./arrayEqualityCheck-y2Q9GogF.js";import{L as D}from"./Layer-D0lgb40K.js";import{R as De}from"./Rectangle-WKQjNyd_.js";import{R as $e,b as Ae,a as We,T as Ge,n as qe}from"./RechartsWrapper-DkonLtU6.js";import{M as ye,n as fe,N as ge}from"./hooks-BU-t5LUJ.js";import{R as Xe,S as Fe}from"./RegisterGraphicalItemId-qsbqe2qd.js";import{S as Oe}from"./chartDataContext-RIukKWW8.js";import{u as Ye,d as z,e as ve}from"./svgPropertiesAndEvents-DLjmXQI2.js";import{T as ze}from"./Tooltip-_uQNvj8Z.js";import{R as B}from"./RechartsHookInspector-DH476wIm.js";import"./preload-helper-Dp1pzeXC.js";import"./immer-DGWVQIGE.js";import"./index-DUx68t71.js";import"./PolarUtils-CTnnDHZv.js";import"./useAnimationId-W_naYXH9.js";import"./zIndexSlice-_08NoE64.js";import"./renderedTicksSlice-4e9Z0x6u.js";import"./index-CMJrcCvs.js";import"./axisSelectors-BhhfO0Ag.js";import"./d3-scale-Cclz1I6I.js";import"./useElementOffset-B8DfRQ2Q.js";import"./uniqBy-CHW-V9O0.js";import"./types-C-x3ql1e.js";import"./Curve-D7_AU4BE.js";import"./step-Cv8kCHVT.js";import"./path-DyVhHtw_.js";import"./Cross-Ct2MkSFS.js";import"./Sector-TIMVCNQr.js";import"./ZIndexLayer-BoxbsGwS.js";import"./index-DmeQCr0O.js";import"./ChartSizeDimensions-HlWxaGyg.js";import"./OffsetShower-BZMcKLdA.js";import"./PlotAreaShower-DYk3IhVP.js";var q={},ne;function Be(){if(ne)return q;ne=1;const e=Te();function t(s,o){if(!s||!s.length)return 0;o!=null&&(o=e.iteratee(o));let n;for(let i=0;i<s.length;i++){const a=o?o(s[i]):s[i];a!==void 0&&(n===void 0?n=a:n+=a)}return n}return q.sumBy=t,q}var X,ae;function Ke(){return ae||(ae=1,X=Be().sumBy),X}var _e=Ke();const Ue=we(_e),He=(e,t)=>{const s=+e,o=t-s;return n=>s+o*n},L=e=>e.y+e.dy/2,V=e=>e&&e.value||0,j=(e,t)=>t.reduce((s,o)=>s+V(e[o]),0),Je=(e,t,s)=>s.reduce((o,n)=>{const i=t[n];if(i==null)return o;const a=e[i.source];return a==null?o:o+L(a)*V(t[n])},0),Qe=(e,t,s)=>s.reduce((o,n)=>{const i=t[n];if(i==null)return o;const a=e[i.target];return a==null?o:o+L(a)*V(t[n])},0),Ze=(e,t)=>e.y-t.y,et=(e,t)=>{const s=[],o=[],n=[],i=[];for(let a=0,c=e.length;a<c;a++){const r=e[a];(r==null?void 0:r.source)===t&&(n.push(r.target),i.push(a)),(r==null?void 0:r.target)===t&&(s.push(r.source),o.push(a))}return{sourceNodes:s,sourceLinks:o,targetLinks:i,targetNodes:n}},ke=(e,t)=>{const{targetNodes:s}=t;for(let o=0,n=s.length;o<n;o++){const i=s[o];if(i==null)continue;const a=e[i];a&&(a.depth=Math.max(t.depth+1,a.depth),ke(e,a))}},tt=({nodes:e,links:t},s,o,n)=>{var c;const i=e.map((r,u)=>{const l=et(t,u);return{...r,...l,value:Math.max(j(t,l.sourceLinks),j(t,l.targetLinks)),depth:0}});for(let r=0,u=i.length;r<u;r++){const l=i[r];l!=null&&!l.sourceNodes.length&&ke(i,l)}const a=((c=Ve(i,r=>r.depth))==null?void 0:c.depth)??0;if(a>=1){const r=(s-o)/a;for(let u=0,l=i.length;u<l;u++){const d=i[u];d!=null&&(d.targetNodes.length||n==="justify"&&(d.depth=a),d.x=d.depth*r,d.dx=o)}}return{tree:i,maxDepth:a}},nt=e=>{var s;const t=[];for(let o=0,n=e.length;o<n;o++){const i=e[o];i!=null&&(t[i.depth]||(t[i.depth]=[]),(s=t[i.depth])==null||s.push(i))}return t},at=(e,t,s,o,n)=>{let i=Math.min(...e.map(a=>{const c=Ue(a,V);return c===0?1/0:(t-(a.length-1)*s)/c}));i===1/0&&(i=0);for(let a=0,c=e.length;a<c;a++){const r=e[a];if(r!=null)if(n==="top"){let u=0;for(let l=0,d=r.length;l<d;l++){const m=r[l];m!=null&&(m.dy=m.value*i,m.y=u,u+=m.dy+s)}}else for(let u=0,l=r.length;u<l;u++){const d=r[u];d!=null&&(d.y=u,d.dy=d.value*i)}}return o.map(a=>({...a,dy:V(a)*i}))},F=(e,t,s,o=!0)=>{for(let n=0,i=e.length;n<i;n++){const a=e[n];if(a==null)continue;const c=a.length;o&&a.sort(Ze);let r=0;for(let u=0;u<c;u++){const l=a[u];if(l==null)continue;const d=r-l.y;d>0&&(l.y+=d),r=l.y+l.dy+s}r=t+s;for(let u=c-1;u>=0;u--){const l=a[u];if(l==null)continue;const d=l.y+l.dy+s-r;if(d>0)l.y-=d,r=l.y;else break}}},ot=(e,t,s,o)=>{for(let n=0,i=t.length;n<i;n++){const a=t[n];if(a!=null)for(let c=0,r=a.length;c<r;c++){const u=a[c];if(u!=null&&u.sourceLinks.length){const l=j(s,u.sourceLinks),d=Je(e,s,u.sourceLinks),m=l===0?L(u):d/l;u.y+=(m-L(u))*o}}}},rt=(e,t,s,o)=>{for(let n=t.length-1;n>=0;n--){const i=t[n];if(i!=null)for(let a=0,c=i.length;a<c;a++){const r=i[a];if(r!=null&&r.targetLinks.length){const u=j(s,r.targetLinks),l=Qe(e,s,r.targetLinks),d=u===0?L(r):l/u;r.y+=(d-L(r))*o}}}},st=(e,t)=>{for(let s=0,o=e.length;s<o;s++){const n=e[s];if(n==null)continue;let i=0,a=0;n.targetLinks.sort((c,r)=>{var k,g,v,E;const u=(k=t[c])==null?void 0:k.target,l=(g=t[r])==null?void 0:g.target;if(u==null||l==null)return 0;const d=(v=e[u])==null?void 0:v.y,m=(E=e[l])==null?void 0:E.y;return d==null||m==null?0:d-m}),n.sourceLinks.sort((c,r)=>{var k,g,v,E;const u=(k=t[c])==null?void 0:k.source,l=(g=t[r])==null?void 0:g.source;if(u==null||l==null)return 0;const d=(v=e[u])==null?void 0:v.y,m=(E=e[l])==null?void 0:E.y;return d==null||m==null?0:d-m});for(let c=0,r=n.targetLinks.length;c<r;c++){const u=n.targetLinks[c];if(u==null)continue;const l=t[u];l&&(l.sy=i,i+=l.dy)}for(let c=0,r=n.sourceLinks.length;c<r;c++){const u=n.sourceLinks[c];if(u==null)continue;const l=t[u];l&&(l.ty=a,a+=l.dy)}}},it=({data:e,width:t,height:s,iterations:o,nodeWidth:n,nodePadding:i,sort:a,verticalAlign:c,align:r})=>{const{links:u}=e,{tree:l}=tt(e,t,n,r),d=nt(l),m=at(d,s,i,u,c);if(F(d,s,i,a),c==="justify"){let g=1;for(let v=1;v<=o;v++)rt(l,d,m,g*=.99),F(d,s,i,a),ot(l,d,m,g),F(d,s,i,a)}return st(l,m),{nodes:l,links:m}},lt=e=>({x:+e.x+ +e.width/2,y:+e.y+ +e.height/2}),ut=e=>"sourceX"in e?{x:(e.sourceX+e.targetX)/2,y:(e.sourceY+e.targetY)/2}:void 0,ct=(e,t,s)=>{const{payload:o}=e;if(t==="node")return{payload:o,name:N(o,s,""),value:N(o,"value")};if("source"in o&&o.source&&o.target){const n=N(o.source,s,""),i=N(o.target,s,"");return{payload:o,name:`${n} - ${i}`,value:N(o,"value")}}},dt=(e,t,s,o)=>{if(t==null||typeof t!="string"||s==null||typeof s!="object")return;const n=t.split("-"),[i,a]=n,c=xe(s,`${i}s[${a}]`);if(c)return ct(c,i,o)},mt={chartName:"Sankey",defaultTooltipEventType:"item",validateTooltipEventTypes:["item"],tooltipPayloadSearcher:dt,eventEmitter:void 0},ht=h.memo(({dataKey:e,nameKey:t,stroke:s,strokeWidth:o,fill:n,name:i,data:a,id:c})=>{const r={dataDefinedOnItem:a,getPosition:Le,settings:{stroke:s,strokeWidth:o,fill:n,dataKey:e,name:i,nameKey:t,hide:!1,type:void 0,color:n,unit:"",graphicalItemId:c}};return h.createElement(Fe,{tooltipEntrySettings:r})});function pt(e,t){if(h.isValidElement(e))return h.cloneElement(e,t);if(typeof e=="function")return e(t);const{sourceX:s,sourceY:o,sourceControlX:n,targetX:i,targetY:a,targetControlX:c,linkWidth:r,...u}=t;return h.createElement("path",{className:"recharts-sankey-link",d:`
          M${s},${o}
          C${n},${o} ${c},${a} ${i},${a}
        `,fill:"none",stroke:"#333",strokeWidth:r,strokeOpacity:"0.2",...z(u)})}const yt=({link:e,nodes:t,left:s,top:o,i:n,linkContent:i,linkCurvature:a})=>{const{sy:c,ty:r,dy:u}=e,l=t[e.source],d=t[e.target];if(l==null||d==null)return;const m=l.x+l.dx+s,k=d.x+s,g=He(m,k),v=g(a),E=g(1-a),T=l.y+c+u/2+o,S=d.y+r+u/2+o;return{sourceX:m,targetX:k,sourceY:T,targetY:S,sourceControlX:v,targetControlX:E,sourceRelativeY:c,targetRelativeY:r,linkWidth:u,index:n,payload:{...e,source:l,target:d},...ve(i)}};function ft({graphicalItemId:e,props:t,i:s,linkContent:o,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:c}){const r=ut(t),u=`link-${s}`,l=pe(),d={onMouseEnter:m=>{l(ge({activeIndex:u,activeDataKey:c,activeCoordinate:r,activeGraphicalItemId:e})),n(t,m)},onMouseLeave:m=>{l(fe()),i(t,m)},onClick:m=>{l(ye({activeIndex:u,activeDataKey:c,activeCoordinate:r,activeGraphicalItemId:e})),a(t,m)}};return h.createElement(D,{...d},pt(o,t))}function gt({graphicalItemId:e,modifiedLinks:t,links:s,linkContent:o,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:c}){return h.createElement(D,{className:"recharts-sankey-links",key:"recharts-sankey-links"},s.map((r,u)=>{const l=t[u];return l==null?null:h.createElement(ft,{graphicalItemId:e,key:`link-${r.source}-${r.target}-${r.value}`,props:l,linkContent:o,i:u,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:c})}))}function vt(e,t){return h.isValidElement(e)?h.cloneElement(e,t):typeof e=="function"?e(t):h.createElement(De,{className:"recharts-sankey-node",fill:"#0088fe",fillOpacity:"0.8",...z(t)})}const kt=({node:e,nodeContent:t,top:s,left:o,i:n})=>{const{x:i,y:a,dx:c,dy:r}=e;return{...ve(t),x:i+o,y:a+s,width:c,height:r,index:n,payload:e}};function bt({graphicalItemId:e,props:t,nodeContent:s,i:o,onMouseEnter:n,onMouseLeave:i,onClick:a,dataKey:c}){const r=pe(),u=lt(t),l=`node-${o}`,d={onMouseEnter:m=>{r(ge({activeIndex:l,activeDataKey:c,activeCoordinate:u,activeGraphicalItemId:e})),n(t,m)},onMouseLeave:m=>{r(fe()),i(t,m)},onClick:m=>{r(ye({activeIndex:l,activeDataKey:c,activeCoordinate:u,activeGraphicalItemId:e})),a(t,m)}};return h.createElement(D,{...d},vt(s,t))}function Et({graphicalItemId:e,modifiedNodes:t,nodeContent:s,onMouseEnter:o,onMouseLeave:n,onClick:i,dataKey:a}){return h.createElement(D,{className:"recharts-sankey-nodes",key:"recharts-sankey-nodes"},t.map((c,r)=>h.createElement(bt,{graphicalItemId:e,key:`node-${c.index}-${c.x}-${c.y}`,props:c,nodeContent:s,i:r,onMouseEnter:o,onMouseLeave:n,onClick:i,dataKey:a})))}const St={align:"justify",dataKey:"value",iterations:32,linkCurvature:.5,margin:{top:5,right:5,bottom:5,left:5},nameKey:"name",nodePadding:10,nodeWidth:10,sort:!0,verticalAlign:"justify",...qe};function Ct(e){var t;return(t=e.components)==null?void 0:t.Sankey}function wt(e){const{className:t,style:s,children:o,id:n,...i}=e,{link:a,dataKey:c,node:r,onMouseEnter:u,onMouseLeave:l,onClick:d,data:m,iterations:k,nodeWidth:g,nodePadding:v,sort:E,linkCurvature:T,margin:S,verticalAlign:A,align:K}=e,be=z(i),w=Re(),x=je(),{links:Ee,modifiedLinks:_,modifiedNodes:U}=h.useMemo(()=>{if(!m||!w||!x||w<=0||x<=0)return{nodes:[],links:[],modifiedLinks:[],modifiedNodes:[]};const p=w-(S.left??0)-(S.right??0),y=x-(S.top??0)-(S.bottom??0),b=it({data:m,width:p,height:y,iterations:k,nodeWidth:g,nodePadding:v,sort:E,verticalAlign:A,align:K}),Z=S.top||0,ee=S.left||0,Se=b.links.map((W,G)=>yt({link:W,nodes:b.nodes,i:G,top:Z,left:ee,linkContent:a,linkCurvature:T})).filter(Ne),Ce=b.nodes.map((W,G)=>kt({node:W,nodeContent:r,i:G,top:Z,left:ee}));return{nodes:b.nodes,links:b.links,modifiedLinks:Se,modifiedNodes:Ce}},[m,w,x,S,k,g,v,E,a,r,T,K,A]),H=h.useCallback((p,y,b)=>{u&&u(p,y,b)},[u]),J=h.useCallback((p,y,b)=>{l&&l(p,y,b)},[l]),Q=h.useCallback((p,y,b)=>{d&&d(p,y,b)},[d]);return!te(w)||!te(x)||!m||!m.links||!m.nodes?null:h.createElement(h.Fragment,null,h.createElement(Oe,{computedData:{links:_,nodes:U}}),h.createElement(Pe,{...be,width:w,height:x},o,h.createElement(gt,{graphicalItemId:n,links:Ee,modifiedLinks:_,linkContent:a,dataKey:c,onMouseEnter:(p,y)=>H(p,"link",y),onMouseLeave:(p,y)=>J(p,"link",y),onClick:(p,y)=>Q(p,"link",y)}),h.createElement(Et,{graphicalItemId:n,modifiedNodes:U,nodeContent:r,dataKey:c,onMouseEnter:(p,y)=>H(p,"node",y),onMouseLeave:(p,y)=>J(p,"node",y),onClick:(p,y)=>Q(p,"node",y)})))}function C(e){const t=Ye(e,St,Ct),{width:s,height:o,style:n,className:i,id:a,throttleDelay:c,throttledEvents:r}=t,[u,l]=h.useState(null);return h.createElement($e,{preloadedState:{options:mt},reduxStoreName:i??"Sankey"},h.createElement(Ie,{width:s,height:o}),h.createElement(Me,{margin:t.margin}),h.createElement(Ae,{throttleDelay:c,throttledEvents:r}),h.createElement(We,{className:i,style:n,width:s,height:o,responsive:!1,ref:d=>{d&&!u&&l(d)},onMouseEnter:void 0,onMouseLeave:void 0,onClick:void 0,onMouseMove:void 0,onMouseDown:void 0,onMouseUp:void 0,onContextMenu:void 0,onDoubleClick:void 0,onTouchStart:void 0,onTouchMove:void 0,onTouchEnd:void 0},h.createElement(Ge.Provider,{value:u},h.createElement(Xe,{id:a,type:"sankey"},d=>h.createElement(h.Fragment,null,h.createElement(ht,{dataKey:t.dataKey,nameKey:t.nameKey,stroke:t.stroke,strokeWidth:t.strokeWidth,fill:t.fill,name:t.name,data:t.data,id:d}),h.createElement(wt,{...t,id:d}))))))}C.displayName="Sankey";try{C.displayName="Sankey",C.__docgenInfo={description:`Flow diagram in which the width of the arrows is proportional to the flow rate.
...
}`,...(ie=(se=I.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var le,ue,ce;M.parameters={...M.parameters,docs:{...(le=M.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: (args: Args) => {
    return <ResponsiveContainer width="100%" height={400}>
        <Sankey data={nodeLinkData} {...args}>
          <RechartsHookInspector />
...
}`,...(ce=(ue=M.parameters)==null?void 0:ue.docs)==null?void 0:ce.source}}};var de,me,he;R.parameters={...R.parameters,docs:{...(de=R.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(he=(me=R.parameters)==null?void 0:me.docs)==null?void 0:he.source}}};const cn=["API","Customized","CustomNodeAndLink"];export{I as API,R as CustomNodeAndLink,M as Customized,cn as __namedExportsOrder,un as default};
