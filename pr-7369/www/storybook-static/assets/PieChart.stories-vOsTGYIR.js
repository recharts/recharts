...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},Fe={argTypes:u,component:c},i={name:"Simple",render:t=>{const{data:r,activeShape:n}=t;return e.createElement(P,{width:"100%",height:400},e.createElement(c,{...t},e.createElement(y,{data:r,dataKey:"uv",shape:({isActive:m,...o})=>e.createElement(F,{...o,fill:m?n.fill:o.fill})}),e.createElement(M,{defaultIndex:3}),e.createElement(g,null)))},args:{...p(u),data:A,activeShape:{fill:"red"},margin:{top:0,right:0,bottom:0,left:0}}},s={render:t=>e.createElement(c,{...t},e.createElement(y,{data:t.data,dataKey:"uv",nameKey:"name",innerRadius:50,outerRadius:80,cornerRadius:8},e.createElement(E,{position:"center",fill:"#000",fontSize:12,fontWeight:"bold",dy:-7},"Donut"),e.createElement(E,{position:"center",fontSize:12,fontWeight:"bold",dy:8},"Chart"),e.createElement(k,{align:"right",verticalAlign:"middle",layout:"vertical"})),e.createElement(g,null)),args:{...p(u),width:500,height:300,data:A}},l={render:t=>{const r=[{x:{value:1},name:"x1",fill:"blue"},{x:{value:2},name:"x2",fill:"red"},{x:{value:3},name:"x3",fill:"green"}],n=[{y:{value:3},name:"y1",fill:"blue"},{y:{value:2},name:"y2",fill:"red"},{y:{value:1},name:"y3",fill:"green"}],m=a=>(v(a.x),a.x.value),o=a=>(v(a.y),a.y.value),[d,b]=f.useState(!1),[z,h]=f.useState(!0);return e.createElement(e.Fragment,null,e.createElement("button",{type:"button",onClick:()=>{b(!1),h(!0)}},"Use data1"),e.createElement("button",{type:"button",onClick:()=>{b(!0),h(!0)}},"Use data2"),e.createElement("button",{type:"button",onClick:()=>{h(!1)}},"Hide"),e.createElement(c,{...t,data:d?n:r},e.createElement(M,null),e.createElement(k,null),e.createElement(g,null),e.createElement(y,{data:d?n:r,name:"Animated line",hide:!z,type:"monotone",dataKey:d?o:m,stroke:"#8884d8",strokeDasharray:"5 5",label:{fill:"red"},animationDuration:3e3})))},args:{...p(u),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}};var C,G,x;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(D=(R=l.parameters)==null?void 0:R.docs)==null?void 0:D.source}}};const Ie=["API","Donut","ChangingDataKey"];export{i as API,l as ChangingDataKey,s as Donut,Ie as __namedExportsOrder,Fe as default};
