...
Locator: locator('#root').locator('internal:control=component')
  3596 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 3834 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4142 pixels (ratio 0.01 of all image pixels) are different.
