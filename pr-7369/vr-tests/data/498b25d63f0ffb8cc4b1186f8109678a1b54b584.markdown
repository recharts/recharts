...
Locator: locator('#root').locator('internal:control=component')
  3838 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 4950 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1322 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4282 pixels (ratio 0.01 of all image pixels) are different.
