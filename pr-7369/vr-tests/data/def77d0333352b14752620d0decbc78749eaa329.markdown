...
Call log:
  ...
  - 722550 pixels (ratio 0.46 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 586946 pixels (ratio 0.37 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 134520 pixels (ratio 0.09 of all image pixels) are different.
