...
Call log:
  ...
  - 12224 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6720 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4923 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 994 pixels (ratio 0.01 of all image pixels) are different.
