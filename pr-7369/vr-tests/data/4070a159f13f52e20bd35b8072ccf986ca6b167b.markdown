...
Call log:
  ...
  - 56323 pixels (ratio 0.32 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 53312 pixels (ratio 0.30 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2743 pixels (ratio 0.02 of all image pixels) are different.
