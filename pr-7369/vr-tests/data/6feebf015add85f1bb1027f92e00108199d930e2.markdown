...
Call log:
  ...
  - 47171 pixels (ratio 0.27 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 45952 pixels (ratio 0.26 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 759 pixels (ratio 0.01 of all image pixels) are different.
