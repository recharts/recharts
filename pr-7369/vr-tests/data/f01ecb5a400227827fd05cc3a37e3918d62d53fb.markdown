...
Call log:
  ...
  - 723723 pixels (ratio 0.46 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 650671 pixels (ratio 0.41 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 72200 pixels (ratio 0.05 of all image pixels) are different.
