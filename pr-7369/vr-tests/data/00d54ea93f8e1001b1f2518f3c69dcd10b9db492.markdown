...
Locator: locator('#root').locator('internal:control=component')
  1679 pixels (ratio 0.02 of all image pixels) are different.
...
- application [ref=e4]:
  - generic [ref=e6]:
    - generic [ref=e7]: top
    - generic [ref=e8]: bottom
    - generic [ref=e9]: left
    - generic [ref=e10]: right
    - generic [ref=e11]: center
    - generic [ref=e12]: insideLeft
    - generic [ref=e13]: insideRight
    - generic [ref=e14]: insideTop
    - generic [ref=e15]: insideBottom
    - generic [ref=e16]: insideTopLeft
    - generic [ref=e17]: insideTopRight
    - generic [ref=e18]: insideBottomLeft
    - generic [ref=e19]: insideBottomRight
```
