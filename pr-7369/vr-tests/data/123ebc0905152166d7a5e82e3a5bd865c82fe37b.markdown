...
Call log:
  ...
  - 722713 pixels (ratio 0.46 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 444819 pixels (ratio 0.28 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 256559 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 19899 pixels (ratio 0.02 of all image pixels) are different.
