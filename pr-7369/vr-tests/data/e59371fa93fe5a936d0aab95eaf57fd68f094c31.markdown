...
Call log:
  ...
  - 717408 pixels (ratio 0.45 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 648886 pixels (ratio 0.41 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 67634 pixels (ratio 0.05 of all image pixels) are different.
