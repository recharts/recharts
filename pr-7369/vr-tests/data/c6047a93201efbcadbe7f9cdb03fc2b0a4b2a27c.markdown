...
Locator: locator('#root').locator('internal:control=component')
  502 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 11809 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3577 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5603 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3086 pixels (ratio 0.02 of all image pixels) are different.
...
- generic [ref=e3]:
  ...
  - application [ref=e27]:
    - generic [ref=e61]:
      - generic [ref=e62]: "31.47"
      - generic [ref=e63]: "26.69"
      - generic [ref=e64]: "15.69"
      - generic [ref=e65]: "8.22"
      - generic [ref=e66]: "8.63"
      - generic [ref=e67]: "2.63"
      - generic [ref=e68]: "6.67"
```
