...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3631 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5602 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3116 pixels (ratio 0.02 of all image pixels) are different.
