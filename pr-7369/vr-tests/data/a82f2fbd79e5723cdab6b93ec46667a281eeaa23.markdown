...
Call log:
  ...
  - 722370 pixels (ratio 0.46 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 455225 pixels (ratio 0.29 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 254989 pixels (ratio 0.16 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 10590 pixels (ratio 0.01 of all image pixels) are different.
