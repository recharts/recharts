...
Locator: locator('#root').locator('internal:control=component')
  3464 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 5470 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1956 pixels (ratio 0.01 of all image pixels) are different.
