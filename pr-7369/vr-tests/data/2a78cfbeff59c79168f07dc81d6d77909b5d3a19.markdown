...
Locator: locator('#root').locator('internal:control=component')
  3714 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 4642 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5045 pixels (ratio 0.02 of all image pixels) are different.
