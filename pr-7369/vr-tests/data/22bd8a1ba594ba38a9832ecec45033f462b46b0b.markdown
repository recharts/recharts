...
Locator: locator('#root').locator('internal:control=component')
  3576 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - 5884 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4404 pixels (ratio 0.01 of all image pixels) are different.
