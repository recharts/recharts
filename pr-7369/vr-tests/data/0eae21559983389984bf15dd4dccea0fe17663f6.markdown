...
Call log:
  ...
  - 691812 pixels (ratio 0.44 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 548268 pixels (ratio 0.35 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 142352 pixels (ratio 0.09 of all image pixels) are different.
