import{e}from"./iframe-BlTD-rim.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-rwI72tz9.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-CG2HUbW2.js";import{B as a}from"./Bar-DtSTN1J_.js";import{L as d}from"./Line-9EEW6LJO.js";import{R as D}from"./arrayEqualityCheck-rFMbtr9X.js";import{R}from"./RechartsHookInspector-AxC62fMg.js";import{X as u}from"./XAxis-9FZ95w2s.js";import{Y as y}from"./YAxis-CzxGswUN.js";import{L as h}from"./Legend-DwZMZD9h.js";import{C as f}from"./CartesianGrid-BW3y60TI.js";import{R as j}from"./ReferenceLine-B7WgqRCX.js";import{R as H}from"./ReferenceDot-BH2KSmVO.js";import{B as I}from"./Brush-B6sZeNvd.js";import{L as X}from"./LineChart-BHJExF-c.js";import{T as g}from"./Tooltip-gQubTM6T.js";import{S as Y}from"./Scatter-Dp6rtUul.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
