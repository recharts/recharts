import{R as n}from"./iframe-Czgh02fE.js";import{T as l}from"./Text-CR_8UZPv.js";import{S as s}from"./isWellBehavedNumber-BenVrlkW.js";import"./preload-helper-Dp1pzeXC.js";import"./get-C2VjdU0L.js";import"./resolveDefaultProps-D61FhKsp.js";import"./DOMUtils-CFgNHwO1.js";import"./useBackwardsCompatibleTheme-CqikxVTG.js";const o={angle:{description:`Text rotation angle in degrees.
...
The alignment calculation uses capHeight and lineHeight to determine the starting dy offset.`,control:{type:"select"},options:["end","middle","start"],table:{type:{summary:'"end" | "middle" | "start"'},category:"General",defaultValue:{summary:"end"}},defaultValue:"end"},width:{description:"When width is specified, the text will automatically wrap by calculating the width of text.",table:{type:{summary:"number | string"},category:"General"}}},b={argTypes:o,component:l},e={render:t=>n.createElement(s,{width:500,height:300},n.createElement(l,{...t},t.content)),args:{breakAll:!1,lineHeight:"1em",maxLines:3,scaleToFit:!1,textAnchor:"start",verticalAnchor:"start",angle:0,width:200,y:50,x:50,content:"This is really, really, really, really, really, really, really, really, really long text"}};var a,r,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
...
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const g=["API"];export{e as API,g as __namedExportsOrder,b as default};
