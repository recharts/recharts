import{r as d,n as l,a as c}from"./iframe-B9fQ2oqm.js";import{d as p,c as u,u as h,b as m}from"./arrayEqualityCheck-BL4DC-lX.js";import{r as f,u as I,s as x}from"./zIndexSlice-Dtm-TxeQ.js";function a({zIndex:e,children:r}){const n=p()&&e!==void 0&&e!==0,s=u(),t=h();d.useLayoutEffect(()=>n?(t(f({zIndex:e})),()=>{t(I({zIndex:e}))}):l,[t,e,n]);const o=m(i=>x(i,e,s));return n?o?c.createPortal(r,o):null:r}try{a.displayName="ZIndexLayer",a.__docgenInfo={description:`A layer that renders its children into a portal corresponding to the given zIndex.
