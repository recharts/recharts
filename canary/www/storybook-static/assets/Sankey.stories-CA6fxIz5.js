...
the value of each link is directly taken from the 'value' property of the link objects.`,name:"dataKey",required:!1,type:{name:"string | number | ((obj: any) => any)"}},data:{defaultValue:null,description:`The source data, including the array of nodes, and the relationships, represented by links.
