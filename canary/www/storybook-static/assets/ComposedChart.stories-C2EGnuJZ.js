import{e}from"./iframe-B8wZLo82.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-BcqGzy_j.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-B9VPBSJg.js";import{B as a}from"./Bar-DZSjuuu2.js";import{L as d}from"./Line-da8_ePOc.js";import{R as D}from"./arrayEqualityCheck-mQHvFPpg.js";import{R}from"./RechartsHookInspector-GmoDPQRs.js";import{X as u}from"./XAxis-BVtf3sZB.js";import{Y as y}from"./YAxis-DRyjSKtp.js";import{L as h}from"./Legend-nundP5JZ.js";import{C as f}from"./CartesianGrid-C9NEb3ca.js";import{R as j}from"./ReferenceLine-DXdhesiv.js";import{R as H}from"./ReferenceDot-CEcT8O0E.js";import{B as I}from"./Brush-CqwA1qCH.js";import{L as X}from"./LineChart-gt1i4IL8.js";import{T as g}from"./Tooltip-CQ99GayR.js";import{S as Y}from"./Scatter-TTj4HDGQ.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
