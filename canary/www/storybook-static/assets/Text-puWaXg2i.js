...
@defaultValue 'start'`,name:"textAnchor",required:!1,type:{name:"enum",value:[{value:'"end"'},{value:'"start"'},{value:'"middle"'},{value:'"inherit"'}]}},verticalAnchor:{defaultValue:null,description:`Vertical text alignment relative to the y coordinate.
...
@defaultValue 'end'`,name:"verticalAnchor",required:!1,type:{name:"enum",value:[{value:'"end"'},{value:'"start"'},{value:'"middle"'}]}},scaleToFit:{defaultValue:null,description:`When true, scales the text to fit within the specified width.
The text will be scaled down proportionally to fit the available space.
