import{e as t}from"./iframe-DVKGYMpC.js";import{P as o}from"./_data-CE1j0ret.js";import{g as d}from"./utils-ePvtT4un.js";import{T as n}from"./TooltipArgs-BBATqmz9.js";import{T as p}from"./Tooltip-2satjD6Z.js";import{R as l}from"./arrayEqualityCheck-C3dMZwVz.js";import{C as c}from"./ComposedChart-DpZn3J7A.js";import{A as r}from"./Area-BZFGp0pa.js";import{L as g}from"./Line-DM6-icql.js";import{X as A}from"./XAxis-WP1B-t-F.js";import{Y as u}from"./YAxis-36kfWwzX.js";import{L as v}from"./Legend-DMhQGeFy.js";import{R as f}from"./RechartsHookInspector-BRvRKLe7.js";import{p as T}from"./Page-Cj8EiXz7.js";const y={argTypes:n,title:"API/hooks/useActiveTooltipDataPoints",component:p},C=o.map(e=>({name:e.name,uv:e.uv})),P=o.map(e=>({name:e.name,pv:e.pv})),D=o.map(e=>({name:e.name,amt:e.amt})),a={name:"useActiveTooltipDataPoints",render:e=>t.createElement(l,{width:"100%",height:400},t.createElement(c,{data:T},t.createElement(r,{data:P,dataKey:"pv"}),t.createElement(r,{data:C,dataKey:"uv"}),t.createElement(g,{data:D,dataKey:"amt"}),t.createElement(A,{dataKey:"name",allowDuplicatedCategory:!1}),t.createElement(u,null),t.createElement(v,null),t.createElement(p,{...e}),t.createElement(f,{defaultOpened:"useActiveTooltipDataPoints"}))),args:d(n)};var s,m,i;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
