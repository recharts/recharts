import{r as L,G as K}from"./iframe-BvoaHdmy.js";import{c as J}from"./get-C2VjdU0L.js";import{o as q,r as ee,c as O,b as te,i as v,a as W}from"./resolveDefaultProps-DcaR1-NP.js";import{g as $}from"./DOMUtils-DEiR2hJy.js";import{a as F}from"./isWellBehavedNumber-BXi0lz-u.js";const C=/(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,H=/(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,ne=/^(px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q)$/,se=/(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/,re={cm:96/2.54,mm:96/25.4,pt:96/72,pc:96/6,in:96,Q:96/(2.54*40),px:1},ae=["cm","mm","pt","pc","in","Q","px"];function ie(t){return ae.includes(t)}const T="NaN";function oe(t,e){return t*re[e]}const c=class c{constructor(e,n){this.num=e,this.unit=n,this.num=e,this.unit=n,q(e)&&(this.unit=""),n!==""&&!ne.test(n)&&(this.num=NaN,this.unit=""),ie(n)&&(this.num=oe(e,n),this.unit="px")}static parse(e){const[,n,r]=se.exec(e)??[];return n==null?c.NaN:new c(parseFloat(n),r??"")}add(e){return this.unit!==e.unit?new c(NaN,""):new c(this.num+e.num,this.unit)}subtract(e){return this.unit!==e.unit?new c(NaN,""):new c(this.num-e.num,this.unit)}multiply(e){return this.unit!==""&&e.unit!==""&&this.unit!==e.unit?new c(NaN,""):new c(this.num*e.num,this.unit||e.unit)}divide(e){return this.unit!==""&&e.unit!==""&&this.unit!==e.unit?new c(NaN,""):new c(this.num/e.num,this.unit||e.unit)}toString(){return`${this.num}${this.unit}`}isNaN(){return q(this.num)}};c.NaN=new c(NaN,"");let g=c;function M(t){if(t==null||t.includes(T))return T;let e=t;for(;e.includes("*")||e.includes("/");){const[,n,r,o]=C.exec(e)??[],l=g.parse(n??""),s=g.parse(o??""),a=r==="*"?l.multiply(s):l.divide(s);if(a.isNaN())return T;e=e.replace(C,a.toString())}for(;e.includes("+")||/.-\d+(?:\.\d+)?/.test(e);){const[,n,r,o]=H.exec(e)??[],l=g.parse(n??""),s=g.parse(o??""),a=r==="+"?l.add(s):l.subtract(s);if(a.isNaN())return T;e=e.replace(H,a.toString())}return e}const U=/\(([^()]*)\)/;function le(t){let e=t,n;for(;(n=U.exec(e))!=null;){const[,r]=n,o=M(r);e=e.replace(U,()=>o)}return e}function ce(t){let e=t.replace(/\s+/g,"");return e=le(e),e=M(e),e}function de(t){try{return ce(t)}catch{return T}}function k(t){const e=de(t.slice(5,-1));return e===T?"":e}const X=/[ \f\n\r\t\v\u2028\u2029]+/,Z=({children:t,breakAll:e,style:n})=>{try{let r=[];W(t)||(e?r=t.toString().split(""):r=t.toString().split(X));const o=r.map(s=>({word:s,width:$(s,n).width})),l=e?0:$(" ",n).width;return{wordsWithComputedWidth:o,spaceWidth:l}}catch{return null}};function G(t){return t==="start"||t==="middle"||t==="end"||t==="inherit"}function B(t){return W(t)||typeof t=="string"||typeof t=="number"||typeof t=="boolean"}const Q=(t,e,n,r)=>t.reduce((o,{word:l,width:s})=>{const a=o[o.length-1];if(a&&s!=null&&(e==null||r||a.width+s+n<Number(e)))a.words.push(l),a.width+=s+n;else{const u={words:[l],width:s};o.push(u)}return o},[]),j=t=>t.reduce((e,n)=>e.width>n.width?e:n),ue="…",z=(t,e,n,r,o,l,s,a)=>{const u=t.slice(0,e),d=Z({breakAll:n,style:r,children:u+ue});if(!d)return[!1,[]];const i=Q(d.wordsWithComputedWidth,l,s,a);return[i.length>o||j(i).width>Number(l),i]},he=({maxLines:t,children:e,style:n,breakAll:r},o,l,s,a)=>{const u=v(t),d=String(e),i=Q(o,s,l,a);if(!u||a||!(i.length>t||j(i).width>Number(s)))return i;let f=0,x=d.length-1,b=0,_;for(;f<=x&&b<=d.length-1;){const w=Math.floor((f+x)/2),A=w-1,[h,N]=z(d,A,r,n,t,s,l,a),[p]=z(d,w,r,n,t,s,l,a);if(!h&&!p&&(f=w+1),h&&p&&(x=w-1),!h&&p){_=N;break}b++}return _||i},D=t=>[{words:W(t)?[]:t.toString().split(X),width:void 0}],R=({width:t,scaleToFit:e,children:n,style:r,breakAll:o,maxLines:l})=>{if((t||e)&&!K.isSsr){let s,a;const u=Z({breakAll:o,children:n,style:r});if(u){const{wordsWithComputedWidth:d,spaceWidth:i}=u;s=d,a=i}else return D(n);return he({breakAll:o,children:n,maxLines:l,style:r},s,a,t,!!e)}return D(n)},Y="#808080",pe={angle:0,breakAll:!1,capHeight:"0.71em",fill:Y,lineHeight:"1em",scaleToFit:!1,textAnchor:"start",verticalAnchor:"end",x:0,y:0},S=L.forwardRef((t,e)=>{const{x:n,y:r,lineHeight:o,capHeight:l,fill:s,scaleToFit:a,textAnchor:u,verticalAnchor:d,...i}=ee(t,pe),m=L.useMemo(()=>R({breakAll:i.breakAll,children:i.children,maxLines:i.maxLines,scaleToFit:a,style:i.style,width:i.width}),[i.breakAll,i.children,i.maxLines,a,i.style,i.width]),{dx:f,dy:x,angle:b,className:_,breakAll:w,...A}=i;if(!O(n)||!O(r)||m.length===0)return null;const h=Number(n)+(v(f)?f:0),N=Number(r)+(v(x)?x:0);if(!F(h)||!F(N))return null;let p;switch(d){case"start":p=k(`calc(${l})`);break;case"middle":p=k(`calc(${(m.length-1)/2} * -${o} + (${l} / 2))`);break;default:p=k(`calc(${m.length-1} * -${o})`);break}const P=[],V=m[0];if(a&&V!=null){const E=V.width,{width:y}=i;P.push(`scale(${v(y)&&v(E)?y/E:1})`)}return b&&P.push(`rotate(${b}, ${h}, ${N})`),P.length&&(A.transform=P.join(" ")),L.createElement("text",{...te(A),ref:e,x:h,y:N,className:J("recharts-text",_),textAnchor:u,fill:s.includes("url")?Y:s},m.map((E,y)=>{const I=E.words.join(w?"":" ");return L.createElement("tspan",{x:h,dy:y===0?p:o,key:`${I}-${y}`},I)}))});S.displayName="Text";try{G.displayName="isValidTextAnchor",G.__docgenInfo={description:"",displayName:"isValidTextAnchor",filePath:"/__w/recharts/recharts/src/component/Text.tsx",methods:[],props:{},tags:{}}}catch{}try{B.displayName="isRenderableText",B.__docgenInfo={description:"",displayName:"isRenderableText",filePath:"/__w/recharts/recharts/src/component/Text.tsx",methods:[],props:{},tags:{}}}catch{}try{R.displayName="getWordsByLines",R.__docgenInfo={description:"",displayName:"getWordsByLines",filePath:"/__w/recharts/recharts/src/component/Text.tsx",methods:[],props:{scaleToFit:{defaultValue:null,declarations:[{fileName:"recharts/src/component/Text.tsx",name:"TextProps"}],description:`When true, scales the text to fit within the specified width.
...
**Note:** This controls horizontal alignment only and does not affect RTL text behavior.`,name:"textAnchor",parent:{fileName:"recharts/src/component/Text.tsx",name:"TextProps"},required:!1,tags:{defaultValue:"'start'"},type:{name:"enum",raw:"TextAnchor",value:[{value:'"inherit"'},{value:'"end"'},{value:'"middle"'},{value:'"start"'}]}},verticalAnchor:{defaultValue:null,declarations:[{fileName:"recharts/src/component/Text.tsx",name:"TextProps"}],description:`Vertical text alignment relative to the y coordinate.
