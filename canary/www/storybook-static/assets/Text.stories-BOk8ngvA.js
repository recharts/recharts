import{R as n}from"./iframe-Dsugo_zg.js";import{T as l}from"./Text-BrgPWmaV.js";import{S as s}from"./isWellBehavedNumber-BXhYPRs7.js";import"./preload-helper-Dp1pzeXC.js";import"./get-B4-DsMlp.js";import"./resolveDefaultProps-ByiopbeA.js";import"./DOMUtils-Bp38L-kM.js";const o={angle:{description:`Text rotation angle in degrees.
...
The alignment calculation uses capHeight and lineHeight to determine the starting dy offset.`,control:{type:"select"},options:["end","middle","start"],table:{type:{summary:'"end" | "middle" | "start"'},category:"General",defaultValue:{summary:"end"}},defaultValue:"end"},width:{description:"When width is specified, the text will automatically wrap by calculating the width of text.",table:{type:{summary:"number | string"},category:"General"}}},f={argTypes:o,component:l},e={render:t=>n.createElement(s,{width:500,height:300},n.createElement(l,{...t},t.content)),args:{breakAll:!1,lineHeight:"1em",maxLines:3,scaleToFit:!1,textAnchor:"start",verticalAnchor:"start",angle:0,width:200,y:50,x:50,content:"This is really, really, really, really, really, really, really, really, really long text"}};var a,r,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
...
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const b=["API"];export{e as API,b as __namedExportsOrder,f as default};
