import{e}from"./iframe-C7VEdwDl.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-D8hmsnRR.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-BDk8NO0m.js";import{B as a}from"./Bar-CM-GTHTd.js";import{L as d}from"./Line-CSu5WlAZ.js";import{R as D}from"./arrayEqualityCheck-BFuWEF_2.js";import{R}from"./RechartsHookInspector-zossHO9I.js";import{X as u}from"./XAxis-lTITefqV.js";import{Y as y}from"./YAxis-BhBQhR2H.js";import{L as h}from"./Legend-Bp5MdZLe.js";import{C as f}from"./CartesianGrid-Dk9Js2CK.js";import{R as j}from"./ReferenceLine-Cc8phRa7.js";import{R as H}from"./ReferenceDot-DXYgxWEo.js";import{B as I}from"./Brush-BBn5cG46.js";import{L as X}from"./LineChart-C-Gpe0VS.js";import{T as g}from"./Tooltip-nM3QPx50.js";import{S as Y}from"./Scatter-iPPNDKaD.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
