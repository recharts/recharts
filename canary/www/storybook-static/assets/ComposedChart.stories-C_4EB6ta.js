import{e}from"./iframe-CsBbFWpF.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-BxAEf0za.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-D4B3V4QE.js";import{B as a}from"./Bar-DnPRHuD-.js";import{L as d}from"./Line-8NeaciPU.js";import{R as D}from"./arrayEqualityCheck-jcy1YLjA.js";import{R}from"./RechartsHookInspector-Ce0vrec4.js";import{X as u}from"./XAxis-n00lD-aM.js";import{Y as y}from"./YAxis-Ctuh_Y30.js";import{L as h}from"./Legend-BwPUQflq.js";import{C as f}from"./CartesianGrid-CaHAkppf.js";import{R as j}from"./ReferenceLine-DE2xK5S0.js";import{R as H}from"./ReferenceDot-ByqE_Rnj.js";import{B as I}from"./Brush-C2CXFv6b.js";import{L as X}from"./LineChart-DMyxn1iz.js";import{T as g}from"./Tooltip-B8PRtCZT.js";import{S as Y}from"./Scatter-BhdYxTee.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
