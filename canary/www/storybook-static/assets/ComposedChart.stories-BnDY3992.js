import{e}from"./iframe-C2m-yPM5.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-CnOpfs4O.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-Blj9SOMc.js";import{B as a}from"./Bar-BQH173y3.js";import{L as d}from"./Line-DQZ-cp1P.js";import{R as D}from"./arrayEqualityCheck-TbGkdOW0.js";import{R}from"./RechartsHookInspector-hZPAuXLN.js";import{X as u}from"./XAxis-pwIeR2Z_.js";import{Y as y}from"./YAxis-UtKchpqB.js";import{L as h}from"./Legend-Bl5gozJt.js";import{C as f}from"./CartesianGrid-_Vu6X4Ru.js";import{R as j}from"./ReferenceLine-C8JTj_jm.js";import{R as H}from"./ReferenceDot-C2MY2piC.js";import{B as I}from"./Brush-BeD4pZ3A.js";import{L as X}from"./LineChart-BP_rZsno.js";import{T as g}from"./Tooltip-CASLOoZ8.js";import{S as Y}from"./Scatter-CddeSK_D.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
