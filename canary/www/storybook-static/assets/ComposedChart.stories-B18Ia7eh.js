import{e}from"./iframe-2t9JIeSz.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-CKj3iGz6.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-BK3NmA4K.js";import{B as a}from"./Bar-kr-FpNRo.js";import{L as d}from"./Line-BuJmFTie.js";import{R as D}from"./arrayEqualityCheck-Ne24Ckb0.js";import{R}from"./RechartsHookInspector-l9P1RfFo.js";import{X as u}from"./XAxis-RUsgvceF.js";import{Y as y}from"./YAxis-DOtUVqzp.js";import{L as h}from"./Legend-BBddR5ra.js";import{C as f}from"./CartesianGrid-BgfG3uYI.js";import{R as j}from"./ReferenceLine-DY3aZ5_7.js";import{R as H}from"./ReferenceDot-B9-LGDLl.js";import{B as I}from"./Brush-Cz9M3ozJ.js";import{L as X}from"./LineChart-B-BuLFrY.js";import{T as g}from"./Tooltip-DAiegNE1.js";import{S as Y}from"./Scatter-DRsB9mep.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
