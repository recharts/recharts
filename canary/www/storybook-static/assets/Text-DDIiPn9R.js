...
@defaultValue 'start'`,name:"textAnchor",required:!1,type:{name:"enum",value:[{value:'"inherit"'},{value:'"end"'},{value:'"middle"'},{value:'"start"'}]}},lineHeight:{defaultValue:null,description:`Line height for multi-line text.
