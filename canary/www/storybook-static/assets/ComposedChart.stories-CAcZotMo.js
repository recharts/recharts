import{e}from"./iframe-ZLLTs1L2.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-I5bjg5En.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-BYHBALC8.js";import{B as a}from"./Bar-BjBvWlb1.js";import{L as d}from"./Line-BN6F4eoo.js";import{R as D}from"./arrayEqualityCheck-DulyWTfD.js";import{R}from"./RechartsHookInspector-BKmDjbuV.js";import{X as u}from"./XAxis-CHTCY5Jh.js";import{Y as y}from"./YAxis-BCMoz5bl.js";import{L as h}from"./Legend-Dqil_PZE.js";import{C as f}from"./CartesianGrid-RpQXF-Dz.js";import{R as j}from"./ReferenceLine-CYKVYevR.js";import{R as H}from"./ReferenceDot-DK8b8EtT.js";import{B as I}from"./Brush-DcJLmuDV.js";import{L as X}from"./LineChart-CdZlvONq.js";import{T as g}from"./Tooltip-Bed7mk_T.js";import{S as Y}from"./Scatter-C0gwTcki.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
