...
@defaultValue 'start'`,name:"textAnchor",required:!1,type:{name:"enum",value:[{value:'"inherit"'},{value:'"end"'},{value:'"middle"'},{value:'"start"'}]}},verticalAnchor:{defaultValue:null,description:`Vertical text alignment relative to the y coordinate.
