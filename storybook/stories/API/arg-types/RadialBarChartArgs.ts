...
export const RadialBarChartArgs: StorybookArgs = {
  accessibilityLayer: {
  ...
  stackOffset: {
    ...
    options: ['none', 'sign', 'expand', 'wiggle', 'silhouette', 'positive'],
    table: {
      type: {
        summary: '"expand" | "none" | "positive" | "sign" | "silhouette" | "wiggle"',
      },
      category: 'General',
      defaultValue: {
        summary: 'none',
