...
export const ReferenceComponentStyle: Args = {
  ...
  ifOverflow: {
    description: `Defines how to draw the reference component if it falls partly outside the canvas. If set to 'discard', 
    the reference component will not be drawn at all. If set to 'hidden', the reference component will be clipped to the canvas. 
    If set to 'visible', the reference component will be drawn completely. If set to 'extendDomain', 
    the domain of the overflown axis will be extended such that the reference component fits into the canvas.`,
...
export const ReferenceComponentInternalArgs: Args = {
  ...
  clipPathId: {
    description:
      "Used as the id for the clip path which is used to clip the reference component if 'ifOverflow' is set to 'hidden'",
