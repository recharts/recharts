...
export default {
  component: PolarScatter,
};

export const General = {
  render: () => (
    <div style={{ width: '100%', maxWidth: 560, margin: '0 auto', fontFamily }}>
      <div style={{ marginBottom: 12, textAlign: 'center', fontSize: 28, fontWeight: 500 }}>
        Scatter Plot on Polar Axis
      </div>
      <ResponsiveContainer width="100%" aspect={1}>
        <PolarScatterChart data={data} cx="50%" cy="50%" innerRadius={0} outerRadius="88%">
          ...
          />
          <PolarScatter dataKey="radius" size={42} isAnimationActive={false}>
