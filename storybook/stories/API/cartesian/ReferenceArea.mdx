...
<p>
  This component, unlike Rectangle or rect, is aware of the cartesian coordinate system, so you specify the area by
...
<p>
  If you prefer to render rectangles using pixels rather than data coordinates, consider using the Rectangle component
  instead.
</p>
