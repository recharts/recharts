...
<p>
  Please use the <code>shape</code> prop or <code>content</code> prop on the respective chart components to customize
  the rendering of chart elements instead of using <code>Cell</code>.
</p>
