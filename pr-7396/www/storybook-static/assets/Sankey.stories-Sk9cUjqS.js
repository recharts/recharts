...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},an={argTypes:$,component:E},V={name:"Simple",render:e=>k.createElement(Y,{width:"100%",height:400},k.createElement(E,{data:D,...e},k.createElement(Ye,null))),args:{...O($),data:D}},M={render:e=>k.createElement(Y,{width:"100%",height:400},k.createElement(E,{data:D,...e})),args:{...O($),data:D,nodeWidth:10,nodePadding:60,height:500,width:960}},j={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],s=n=>k.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),r=n=>k.createElement("g",null,k.createElement("path",{d:`
...
}`,...(me=(de=j.parameters)==null?void 0:de.docs)==null?void 0:me.source}}};const rn=["API","Customized","CustomNodeAndLink"];export{V as API,j as CustomNodeAndLink,M as Customized,rn as __namedExportsOrder,an as default};
