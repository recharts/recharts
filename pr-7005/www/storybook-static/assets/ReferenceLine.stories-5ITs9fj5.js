import{e}from"./iframe-BdYBH0hQ.js";import{g as l}from"./utils-ePvtT4un.js";import{R as o}from"./ReferenceLine-DjyYzk4F.js";import{R as d}from"./arrayEqualityCheck-CnZHVnux.js";import{C as m}from"./ComposedChart-BGyCZHRq.js";import{C as c}from"./CartesianGrid-CogLHW9f.js";import{X as p}from"./XAxis-C-6SXyUA.js";import{Y as u}from"./YAxis-i93sK3J3.js";import{L as h}from"./Line-Dl92IfyZ.js";import{R as y}from"./RechartsHookInspector-XSvtem8K.js";import{p as f}from"./Page-Cj8EiXz7.js";const i={className:{control:{type:"text"},table:{type:{summary:"string"},category:"Style"}},ifOverflow:{description:"Defines how to draw this component if it falls partly outside the canvas:\n\n- `discard`: the whole component will not be drawn at all\n- `hidden`: the component will be clipped to the chart plot area\n- `visible`: the component will be drawn completely\n- `extendDomain`: the domain of the overflown axis will be extended such that the whole component fits into the plot area",table:{type:{summary:'"discard" | "extendDomain" | "hidden" | "visible"'},category:"General",defaultValue:{summary:"discard"}},defaultValue:"discard"},label:{description:"Renders a single label.\n\n- `false`: no labels are rendered\n- `string` | `number`: the content of the label\n- `object`: the props of LabelList component\n- `ReactElement`: a custom label element\n- `function`: a render function of custom label",table:{type:{summary:"(union of 6 variants)"},category:"General",defaultValue:{summary:"false"}},defaultValue:!1},position:{description:`The position of the reference line when the axis has bandwidth
