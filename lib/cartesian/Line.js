...
var Line = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Line, [{
    ...
    value: function render() {
      ...
      var _ref2 = (0, _types.filterProps)(dot) || {
        r: 3,
        strokeWidth: 2
      },
          r = _ref2.r,
      ...
      }))) : null, !hasSinglePoint && this.renderCurve(needClip, clipPathId), this.renderErrorBar(), (hasSinglePoint || dot) && this.renderDots(needClip, clipDot, clipPathId), (!isAnimationActive || isAnimationFinished) && _LabelList.LabelList.renderCallByParent(this.props, points));
    }
  }], [{
...
Line.getComposedData = function (_ref4) {
