...
/***/ function(module, exports, __webpack_require__) {
	...
	var PolarRadiusAxis = (0, _pureRenderDecorator2.default)(_class = (_temp = _class2 = function (_React$Component) {
	  ...
	  _createClass(PolarRadiusAxis, [{
	    ...
	    value: function getTickValueCoord(radius) {
	      var _props = this.props;
	    ...
	    value: function renderTicks() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { className: 'axis-ticks' },
	        ticks.map(function (v, i) {
	          var coord = _this2.getTickValueCoord(v.radius);
	  ...
	  ticks: _react.PropTypes.arrayOf(_react.PropTypes.object),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Polygon = (0, _pureRenderDecorator2.default)(_class = (_temp = _class2 = function (_React$Component) {
	  ...
	  return Polygon;
	}(_react2.default.Component), _class2.displayName = 'Polygon', _class2.propTypes = _extends({}, _ReactUtils.PRESENTATION_ATTRIBUTES, {
	  points: _react.PropTypes.arrayOf(_react.PropTypes.shape({
	    x: _react.PropTypes.number,
	    y: _react.PropTypes.number
	  }))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RadarChart = (_temp = _class = function (_React$Component) {
	  ...
	  _createClass(RadarChart, [{
	    ...
	    key: 'getRadiusTicks',
	    value: function getRadiusTicks(ratio, radiusArray) {
	      return radiusArray.map(function (v, i) {
	        return {
	          radius: v,
	          value: v * ratio
	        };
	    ...
	    value: function renderDefaultRadar(_ref2) {
	      ...
	      return _react2.default.createElement(_Polygon2.default, _extends({}, otherProps, { points: points }));
	    }
	  }, {
	    key: 'renderRadars',
	      ...
	      if (radarElements && grid && radiusAxis) {
	        var _ret3 = function () {
	          ...
	          var max = data.reduce(function (prev, current) {
	            ...
	            var currentMax = (_Math2 = Math).max.apply(_Math2, _toConsumableArray(dataKeys.map(function (v) {
	              return current[v];
	            })));
	            return prev > currentMax ? prev : currentMax;
	          }, 0);

	          var cx = grid.props.cx || _this5.props.cx;
	          var cy = grid.props.cy || _this5.props.cy;
	          var startAngle = grid.props.startAngle || _this5.props.startAngle;
	          var innerRadius = grid.props.innerRadius || _this5.props.innerRadius;
	          var outerRadius = grid.props.outerRadius || _this5.props.outerRadius;
	          var clockWise = grid.props.clockWise || _this5.props.clockWise;
	          var gridCount = grid.props.gridCount;

	          return {
	            v: _react2.default.cloneElement(radiusAxis, _extends({
	              angle: _this5.getAngleTicks(len, startAngle, clockWise)[len - 1],
	              ticks: _this5.getRadiusTicks(max / _this5.props.outerRadius, _this5.getGridRadius(gridCount, innerRadius, outerRadius)),
	              cx: cx, cy: cy, startAngle: startAngle, innerRadius: innerRadius, outerRadius: outerRadius, clockWise: clockWise
	            }, radiusAxis.props))
	          };
	        }();
