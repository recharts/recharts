import{r as V}from"./entry-D47B9Koa.js";import{r as W,c as j,t as k,f as q,v as M,o as E}from"./useId-C6E76UIu.js";import{V as g,b0 as x}from"./renderedTicksSlice-BGHCBqvr.js";const w=(n,$)=>{const s=E($-n),o=Math.min(Math.abs($-n),359.999);return s*o},b=({cx:n,cy:$,radius:s,angle:o,sign:t,isExternal:r,cornerRadius:l,cornerIsExternal:a})=>{const c=l*(r?1:-1)+s,e=Math.asin(l/c)/x,h=a?o:o+t*e,i=g(n,$,c,h),f=g(n,$,s,h),p=a?o-t*e:o,y=g(n,$,c*Math.cos(e*x),p);return{center:i,circleTangency:f,lineTangency:y,theta:e}},A=({cx:n,cy:$,innerRadius:s,outerRadius:o,startAngle:t,endAngle:r})=>{const l=w(t,r),a=t+l,c=g(n,$,o,t),e=g(n,$,o,a);let h=M`M ${c.x},${c.y}
    A ${o},${o},0,
    ${+(Math.abs(l)>180)},${+(t>a)},
    ${e.x},${e.y}
