...
@defaultValue 'start'`,name:"textAnchor",required:!1,type:{name:"enum",value:[{value:'"inherit"'},{value:'"end"'},{value:'"middle"'},{value:'"start"'}]}},angle:{defaultValue:null,description:`Text rotation angle in degrees.
