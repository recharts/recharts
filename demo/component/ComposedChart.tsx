    ...
    return (
      <div>
        ...
        <div className="composed-chart-wrapper">
          <ComposedChart width={600} height={400} data={timeData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
      ...
      <div className="line-charts">
        ...
        <div className="composed-chart-wrapper">
          <ResponsiveContainer width="100%" height={300}>
            <ComposedChart width={800} height={400} data={data} margin={{ top: 20, right: 20, bottom: 5, left: 20 }}>
