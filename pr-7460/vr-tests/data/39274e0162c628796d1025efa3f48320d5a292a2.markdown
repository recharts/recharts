...
Call log:
  ...
  - 115277 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 80854 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 31719 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2248 pixels (ratio 0.01 of all image pixels) are different.
