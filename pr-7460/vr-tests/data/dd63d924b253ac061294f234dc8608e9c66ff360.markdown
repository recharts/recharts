...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 63258 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 46967 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 7236 pixels (ratio 0.02 of all image pixels) are different.
