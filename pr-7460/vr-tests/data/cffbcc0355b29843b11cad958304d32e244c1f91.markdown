...
Call log:
  ...
  - 38977 pixels (ratio 0.22 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 37300 pixels (ratio 0.21 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1280 pixels (ratio 0.01 of all image pixels) are different.
