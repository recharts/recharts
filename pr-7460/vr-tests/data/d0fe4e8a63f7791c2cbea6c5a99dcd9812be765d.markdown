...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 46123 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 61095 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 11523 pixels (ratio 0.02 of all image pixels) are different.
