...
Call log:
  ...
  - 192985 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 121247 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 68073 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2825 pixels (ratio 0.01 of all image pixels) are different.
