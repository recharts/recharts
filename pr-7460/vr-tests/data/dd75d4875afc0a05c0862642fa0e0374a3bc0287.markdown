...
Call log:
  ...
  - 11554 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5521 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5070 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1820 pixels (ratio 0.01 of all image pixels) are different.
