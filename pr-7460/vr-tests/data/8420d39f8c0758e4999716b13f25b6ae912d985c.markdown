...
Call log:
  ...
  - 186519 pixels (ratio 0.30 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 141382 pixels (ratio 0.23 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 43912 pixels (ratio 0.07 of all image pixels) are different.
