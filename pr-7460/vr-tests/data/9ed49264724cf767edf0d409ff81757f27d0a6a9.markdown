...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 79380 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 35933 pixels (ratio 0.06 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2675 pixels (ratio 0.01 of all image pixels) are different.
