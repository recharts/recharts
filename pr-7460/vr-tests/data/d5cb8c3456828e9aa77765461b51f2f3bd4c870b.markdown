...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 123872 pixels (ratio 0.20 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 64345 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5226 pixels (ratio 0.01 of all image pixels) are different.
