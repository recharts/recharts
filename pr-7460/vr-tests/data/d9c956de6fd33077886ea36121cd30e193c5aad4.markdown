...
Call log:
  ...
  - 115737 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 90112 pixels (ratio 0.15 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 25085 pixels (ratio 0.04 of all image pixels) are different.
