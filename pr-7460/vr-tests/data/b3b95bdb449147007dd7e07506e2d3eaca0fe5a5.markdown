...
Call log:
  ...
  - 194427 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 127965 pixels (ratio 0.20 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 61885 pixels (ratio 0.10 of all image pixels) are different.
