...
Call log:
  ...
  - 112910 pixels (ratio 0.18 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 89570 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 21729 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1152 pixels (ratio 0.01 of all image pixels) are different.
