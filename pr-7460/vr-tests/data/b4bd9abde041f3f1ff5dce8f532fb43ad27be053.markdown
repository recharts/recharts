...
- Name: tests/RadialBarChart.spec-vr.tsx >> Rings With Implicit Axes
- Location: test-vr/tests/RadialBarChart.spec-vr.tsx:55:5
...
Call log:
  ...
  - 118969 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 73950 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 39744 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4794 pixels (ratio 0.01 of all image pixels) are different.
