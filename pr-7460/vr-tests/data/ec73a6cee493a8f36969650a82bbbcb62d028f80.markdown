...
Call log:
  ...
  - 107580 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 90948 pixels (ratio 0.15 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 16344 pixels (ratio 0.03 of all image pixels) are different.
