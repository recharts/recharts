...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57978 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 52260 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8521 pixels (ratio 0.02 of all image pixels) are different.
