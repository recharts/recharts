...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 60034 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 50382 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6903 pixels (ratio 0.02 of all image pixels) are different.
