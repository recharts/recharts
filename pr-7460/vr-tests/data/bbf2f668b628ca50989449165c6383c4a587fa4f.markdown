...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 64220 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 45171 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8264 pixels (ratio 0.02 of all image pixels) are different.
