...
Call log:
  ...
  - 42101 pixels (ratio 0.24 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 38696 pixels (ratio 0.22 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2944 pixels (ratio 0.02 of all image pixels) are different.
