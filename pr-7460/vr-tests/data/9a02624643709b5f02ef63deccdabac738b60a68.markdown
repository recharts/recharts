...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5768 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5501 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1448 pixels (ratio 0.01 of all image pixels) are different.
