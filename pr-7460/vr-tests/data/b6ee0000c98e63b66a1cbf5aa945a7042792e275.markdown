...
Call log:
  ...
  - 194746 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 115085 pixels (ratio 0.18 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 72504 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6125 pixels (ratio 0.01 of all image pixels) are different.
