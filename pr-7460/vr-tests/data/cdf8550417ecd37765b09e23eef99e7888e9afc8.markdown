...
Call log:
  ...
  - 118019 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 35510 pixels (ratio 0.06 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1048 pixels (ratio 0.01 of all image pixels) are different.
