...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1868 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3683 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1680 pixels (ratio 0.02 of all image pixels) are different.
