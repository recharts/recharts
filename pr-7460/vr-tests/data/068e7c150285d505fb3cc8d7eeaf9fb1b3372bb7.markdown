...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2953 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2817 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1408 pixels (ratio 0.02 of all image pixels) are different.
