...
Call log:
  ...
  - 119269 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 63711 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 49081 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5971 pixels (ratio 0.01 of all image pixels) are different.
