...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 69587 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 44519 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4709 pixels (ratio 0.01 of all image pixels) are different.
