...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 53966 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54503 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 10306 pixels (ratio 0.02 of all image pixels) are different.
