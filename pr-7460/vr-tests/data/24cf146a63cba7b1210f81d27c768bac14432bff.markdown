...
Call log:
  ...
  - 196058 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 97151 pixels (ratio 0.16 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 85594 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 12302 pixels (ratio 0.02 of all image pixels) are different.
