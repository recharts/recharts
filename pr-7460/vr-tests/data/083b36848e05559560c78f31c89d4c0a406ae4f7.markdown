...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 71345 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 39693 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5829 pixels (ratio 0.01 of all image pixels) are different.
