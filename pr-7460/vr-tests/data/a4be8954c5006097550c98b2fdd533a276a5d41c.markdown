...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5615 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5027 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2036 pixels (ratio 0.01 of all image pixels) are different.
