...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 86377 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 28833 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1722 pixels (ratio 0.01 of all image pixels) are different.
