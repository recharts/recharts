...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 59607 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 50177 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8723 pixels (ratio 0.02 of all image pixels) are different.
