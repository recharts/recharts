...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57503 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 52031 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 7804 pixels (ratio 0.02 of all image pixels) are different.
