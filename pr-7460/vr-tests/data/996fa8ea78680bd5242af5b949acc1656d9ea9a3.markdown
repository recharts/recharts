...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 56149 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 56409 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6071 pixels (ratio 0.01 of all image pixels) are different.
