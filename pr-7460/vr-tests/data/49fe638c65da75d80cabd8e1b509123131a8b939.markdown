...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 95429 pixels (ratio 0.15 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 85467 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 13955 pixels (ratio 0.03 of all image pixels) are different.
