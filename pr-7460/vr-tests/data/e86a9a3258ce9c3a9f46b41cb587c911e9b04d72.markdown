...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6119 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4716 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1861 pixels (ratio 0.01 of all image pixels) are different.
