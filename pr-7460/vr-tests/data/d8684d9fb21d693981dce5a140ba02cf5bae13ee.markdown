...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1728 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3486 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1950 pixels (ratio 0.02 of all image pixels) are different.
