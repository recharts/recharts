...
Call log:
  ...
  - 189957 pixels (ratio 0.30 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 115647 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 68678 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4738 pixels (ratio 0.01 of all image pixels) are different.
