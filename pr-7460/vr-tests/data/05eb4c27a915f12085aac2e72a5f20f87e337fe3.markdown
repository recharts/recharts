...
Call log:
  ...
  - 39105 pixels (ratio 0.22 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 33908 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4800 pixels (ratio 0.03 of all image pixels) are different.
