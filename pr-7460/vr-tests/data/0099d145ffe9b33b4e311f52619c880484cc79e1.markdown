...
Call log:
  ...
  - 195881 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 102054 pixels (ratio 0.16 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 82981 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 9881 pixels (ratio 0.02 of all image pixels) are different.
