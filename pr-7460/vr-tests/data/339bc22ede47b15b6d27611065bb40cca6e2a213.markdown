...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 52647 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 55514 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 10634 pixels (ratio 0.02 of all image pixels) are different.
