...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 69860 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 41196 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6611 pixels (ratio 0.02 of all image pixels) are different.
