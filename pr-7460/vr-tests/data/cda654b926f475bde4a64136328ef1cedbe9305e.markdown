...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 140756 pixels (ratio 0.22 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 51972 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2090 pixels (ratio 0.01 of all image pixels) are different.
