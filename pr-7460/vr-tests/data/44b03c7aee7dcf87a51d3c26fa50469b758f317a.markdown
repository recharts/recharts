...
Call log:
  ...
  - 188803 pixels (ratio 0.30 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 147365 pixels (ratio 0.24 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 40794 pixels (ratio 0.07 of all image pixels) are different.
