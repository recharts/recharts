...
Call log:
  ...
  - 119278 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 63266 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 44871 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 10666 pixels (ratio 0.02 of all image pixels) are different.
