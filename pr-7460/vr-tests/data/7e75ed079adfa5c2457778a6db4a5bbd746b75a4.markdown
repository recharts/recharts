...
Call log:
  ...
  - 118688 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 53008 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54138 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 11091 pixels (ratio 0.02 of all image pixels) are different.
