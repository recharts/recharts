...
Call log:
  ...
  - 195323 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 126984 pixels (ratio 0.20 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 65173 pixels (ratio 0.11 of all image pixels) are different.
