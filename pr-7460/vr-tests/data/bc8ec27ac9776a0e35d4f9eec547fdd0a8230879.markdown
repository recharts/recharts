...
Call log:
  ...
  - 7376 pixels (ratio 0.06 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3241 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2876 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1066 pixels (ratio 0.01 of all image pixels) are different.
