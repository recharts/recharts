...
Call log:
  ...
  - 11313 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6797 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4121 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1188 pixels (ratio 0.01 of all image pixels) are different.
