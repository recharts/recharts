...
Call log:
  ...
  - 42293 pixels (ratio 0.24 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 33960 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8000 pixels (ratio 0.05 of all image pixels) are different.
