...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 111271 pixels (ratio 0.18 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 72349 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8546 pixels (ratio 0.02 of all image pixels) are different.
