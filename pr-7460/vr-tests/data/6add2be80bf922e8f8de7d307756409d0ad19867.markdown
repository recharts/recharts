...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1419 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3947 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1836 pixels (ratio 0.02 of all image pixels) are different.
