...
Call log:
  ...
  - 7432 pixels (ratio 0.06 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1637 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3742 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1811 pixels (ratio 0.02 of all image pixels) are different.
