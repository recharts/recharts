...
Call log:
  ...
  - 11375 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6349 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4319 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1513 pixels (ratio 0.01 of all image pixels) are different.
