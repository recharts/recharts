...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 53745 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 56748 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8233 pixels (ratio 0.02 of all image pixels) are different.
