...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2747 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6866 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2912 pixels (ratio 0.01 of all image pixels) are different.
