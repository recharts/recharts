...
Call log:
  ...
  - 112243 pixels (ratio 0.18 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 90166 pixels (ratio 0.15 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 21809 pixels (ratio 0.04 of all image pixels) are different.
