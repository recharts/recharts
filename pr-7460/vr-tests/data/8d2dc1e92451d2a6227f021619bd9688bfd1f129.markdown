...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54934 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 52258 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 11499 pixels (ratio 0.02 of all image pixels) are different.
