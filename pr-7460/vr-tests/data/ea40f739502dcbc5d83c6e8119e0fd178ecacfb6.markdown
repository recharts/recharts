...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 73604 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 40850 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 4302 pixels (ratio 0.01 of all image pixels) are different.
