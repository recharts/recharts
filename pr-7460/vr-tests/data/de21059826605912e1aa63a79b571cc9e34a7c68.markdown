...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 131870 pixels (ratio 0.21 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57514 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2610 pixels (ratio 0.01 of all image pixels) are different.
