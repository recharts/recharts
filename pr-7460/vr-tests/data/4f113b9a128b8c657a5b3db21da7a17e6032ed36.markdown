...
Call log:
  ...
  - 96201 pixels (ratio 0.16 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 78231 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 17533 pixels (ratio 0.03 of all image pixels) are different.
