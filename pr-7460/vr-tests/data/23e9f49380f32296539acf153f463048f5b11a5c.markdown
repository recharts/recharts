...
Call log:
  ...
  - 195821 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 106930 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 78450 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 9385 pixels (ratio 0.02 of all image pixels) are different.
