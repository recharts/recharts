...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1673 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3751 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1786 pixels (ratio 0.02 of all image pixels) are different.
