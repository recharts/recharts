...
Call log:
  ...
  - 41847 pixels (ratio 0.24 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 34922 pixels (ratio 0.20 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6528 pixels (ratio 0.04 of all image pixels) are different.
