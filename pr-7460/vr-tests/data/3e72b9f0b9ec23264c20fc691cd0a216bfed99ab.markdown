...
Call log:
  ...
  - 39239 pixels (ratio 0.22 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 32314 pixels (ratio 0.18 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6464 pixels (ratio 0.04 of all image pixels) are different.
