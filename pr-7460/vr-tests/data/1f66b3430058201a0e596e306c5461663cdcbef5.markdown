...
Call log:
  ...
  - 195738 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 94187 pixels (ratio 0.15 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 88650 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 11848 pixels (ratio 0.02 of all image pixels) are different.
