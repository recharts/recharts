...
Call log:
  ...
  - 11396 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 7216 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3997 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 971 pixels (ratio 0.01 of all image pixels) are different.
