...
Call log:
  ...
  - 107980 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 80822 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 26017 pixels (ratio 0.05 of all image pixels) are different.
