...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 108350 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 80312 pixels (ratio 0.13 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6083 pixels (ratio 0.01 of all image pixels) are different.
