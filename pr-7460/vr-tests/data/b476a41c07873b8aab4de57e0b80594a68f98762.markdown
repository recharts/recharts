...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 59733 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 48686 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8640 pixels (ratio 0.02 of all image pixels) are different.
