...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 64079 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 46873 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6438 pixels (ratio 0.02 of all image pixels) are different.
