...
Call log:
  ...
  - 11085 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 8388 pixels (ratio 0.03 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 2753 pixels (ratio 0.01 of all image pixels) are different.
