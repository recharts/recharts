...
- Location: test-vr/tests/RadialBarChart.spec-vr.tsx:81:5
...
Call log:
  ...
  - 118582 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 60512 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 47531 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 10060 pixels (ratio 0.02 of all image pixels) are different.
