...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 70749 pixels (ratio 0.12 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 40924 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5620 pixels (ratio 0.01 of all image pixels) are different.
