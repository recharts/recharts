...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 69764 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 43825 pixels (ratio 0.07 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5041 pixels (ratio 0.01 of all image pixels) are different.
