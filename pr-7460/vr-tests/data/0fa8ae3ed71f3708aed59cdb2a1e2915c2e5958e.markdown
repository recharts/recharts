...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 89331 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 25692 pixels (ratio 0.05 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 903 pixels (ratio 0.01 of all image pixels) are different.
