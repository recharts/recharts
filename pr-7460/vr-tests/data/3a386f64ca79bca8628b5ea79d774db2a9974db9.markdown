...
Call log:
  ...
  - 193084 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 131625 pixels (ratio 0.21 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57143 pixels (ratio 0.09 of all image pixels) are different.
