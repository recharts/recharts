...
Call log:
  ...
  - 104350 pixels (ratio 0.17 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 84115 pixels (ratio 0.14 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 20004 pixels (ratio 0.04 of all image pixels) are different.
