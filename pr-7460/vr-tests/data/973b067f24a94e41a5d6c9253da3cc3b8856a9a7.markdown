...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57437 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54442 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6891 pixels (ratio 0.02 of all image pixels) are different.
