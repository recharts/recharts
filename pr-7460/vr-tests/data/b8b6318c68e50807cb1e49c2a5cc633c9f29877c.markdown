...
Call log:
  ...
  - 118700 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 62539 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 49476 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6236 pixels (ratio 0.01 of all image pixels) are different.
