...
Call log:
  ...
  - 190604 pixels (ratio 0.30 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 130816 pixels (ratio 0.21 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 56565 pixels (ratio 0.09 of all image pixels) are different.
