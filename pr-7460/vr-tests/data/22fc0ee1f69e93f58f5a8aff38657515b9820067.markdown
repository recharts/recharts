...
Call log:
  ...
  - 7421 pixels (ratio 0.06 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1427 pixels (ratio 0.02 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 3826 pixels (ratio 0.04 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1933 pixels (ratio 0.02 of all image pixels) are different.
