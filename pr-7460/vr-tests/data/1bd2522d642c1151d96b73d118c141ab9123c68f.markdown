...
Call log:
  ...
  - 184083 pixels (ratio 0.29 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 143116 pixels (ratio 0.23 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 39905 pixels (ratio 0.07 of all image pixels) are different.
