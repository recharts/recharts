...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 57235 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54645 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6816 pixels (ratio 0.02 of all image pixels) are different.
