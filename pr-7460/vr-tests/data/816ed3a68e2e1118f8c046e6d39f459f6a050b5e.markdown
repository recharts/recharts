...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 58761 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 51118 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 7387 pixels (ratio 0.02 of all image pixels) are different.
