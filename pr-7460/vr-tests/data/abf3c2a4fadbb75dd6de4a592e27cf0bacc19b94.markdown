...
Call log:
  ...
  - 119250 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 66304 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 46645 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5801 pixels (ratio 0.01 of all image pixels) are different.
