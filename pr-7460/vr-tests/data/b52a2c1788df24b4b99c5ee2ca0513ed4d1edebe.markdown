...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 62593 pixels (ratio 0.10 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 47984 pixels (ratio 0.08 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6594 pixels (ratio 0.02 of all image pixels) are different.
