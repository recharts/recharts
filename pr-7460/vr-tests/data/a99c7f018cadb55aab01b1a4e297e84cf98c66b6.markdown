...
Call log:
  ...
  - 192672 pixels (ratio 0.31 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 117729 pixels (ratio 0.19 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 66037 pixels (ratio 0.11 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 7980 pixels (ratio 0.02 of all image pixels) are different.
