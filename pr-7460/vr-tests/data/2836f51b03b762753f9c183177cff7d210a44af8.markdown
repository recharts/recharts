...
Call log:
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 54399 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 52472 pixels (ratio 0.09 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 11340 pixels (ratio 0.02 of all image pixels) are different.
