import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{G as r,K as i}from"./zIndexSlice-BjTRkmQT.js";import{n as a,t as o}from"./CartesianGrid-CCBCYXia.js";import{n as s,t as c}from"./XAxis-pycmZ_BD.js";import{n as l,t as u}from"./YAxis-DBWXZrF-.js";import{n as d,t as f}from"./ComposedChart-DTG9pxwQ.js";import{r as p,t as m}from"./Page-DUsfWi7y.js";import{n as h,t as g}from"./utils-vqcWnakT.js";var _;function v(){return(v=t((()=>{_={fill:{description:`The background color used to fill the space between grid lines`,control:{type:`color`},table:{type:{summary:`string`},category:`Style`}},fillOpacity:{description:`The opacity of the background used to fill the space between grid lines`,table:{type:{summary:`number | string`},category:`General`}},height:{description:`The height of grid. If undefined, covers the full height of the chart plot area.`,table:{type:{summary:`number | string`},category:`General`}},horizontal:{description:`If set false, no horizontal grid lines will be drawn.`,table:{type:{summary:`(union of 5 variants)`},category:`General`,defaultValue:{summary:`true`}},defaultValue:!0},horizontalCoordinatesGenerator:{description:`A function that generates the y-coordinates of all horizontal lines.`,table:{type:{summary:`HorizontalCoordinatesGenerator`},category:`General`}},horizontalFill:{description:`Defines background color of stripes.
