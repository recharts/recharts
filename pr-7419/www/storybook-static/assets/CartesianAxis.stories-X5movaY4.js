import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{a as r,i}from"./isWellBehavedNumber-Dv8NthpO.js";import{r as a,t as o}from"./CartesianAxis-BXoqQkHT.js";import{n as s,t as c}from"./Tick-BmTbv5eM.js";var l,u,d,f,p;function m(){return(m=t((()=>{l=e(n()),a(),r(),c(),u={x:{description:`The x-coordinate of axis.`,table:{type:{summary:`Number`,defaultValue:0},category:`General`}},y:{description:`The y-coordinate of axis.`,table:{type:{summary:`Number`,defaultValue:0},category:`General`}},width:{description:`The width of axis.`,table:{type:{summary:`Number`,defaultValue:0},category:`General`}},height:{description:`The height of axis.`,table:{type:{summary:`Number`,defaultValue:0},category:`General`}},orientation:{description:`The orientation of axis.`,table:{type:{summary:`top | bottom | left | right`,defaultValue:`bottom`},category:`General`}},viewBox:{description:`The box of viewing area.`,table:{type:{summary:`Object`,defaultValue:{x:0,y:0,width:0,height:0}},category:`General`}},axisLine:{description:`If set false, no axis line will be drawn. If set a object, the option is the configuration of axis line.`,table:{type:{summary:`Boolean | Object`,defaultValue:!0},category:`General`}},tickLine:{description:`If set false, no axis tick lines will be drawn. If set a object,
      ...
      If set a function, the function will be called to render customized label.`,table:{type:{summary:`String | Number | ReactElement | Function`,defaultValue:null},category:`General`}},mirror:{description:`If set true, flips ticks around the axis line, displaying the labels inside the chart instead of outside.`,table:{type:{summary:`Boolean`,defaultValue:!1},category:`General`}},tickMargin:{description:`The margin between tick line and tick.`,table:{type:{summary:`Number`},category:`General`}}},d={component:o,argTypes:{...u}},f={render:e=>{let[t,n]=[600,300];return l.createElement(i,{width:t,height:n,viewBox:{x:0,y:0,width:t,height:n}},l.createElement(o,{viewBox:{x:0,y:0,width:t,height:n},...e}))},args:{ticks:s,orientation:`bottom`,interval:`preserveEnd`,width:500,height:600}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
...
}`,...f.parameters?.docs?.source}}},p=[`API`]})))()}m();export{f as API,p as __namedExportsOrder,d as default};