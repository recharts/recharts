import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{t as n}from"./react-43m7EBoo.js";import{Pt as r,Si as i,t as a}from"./iframe-BqVvK_R4.js";var o,s=e((()=>{o={angle:{description:`Text rotation angle in degrees.
...
The alignment calculation uses capHeight and lineHeight to determine the starting dy offset.`,control:{type:`select`},options:[`end`,`middle`,`start`],table:{type:{summary:`"end" | "middle" | "start"`},category:`General`,defaultValue:{summary:`end`}},defaultValue:`end`},width:{description:`When width is specified, the text will automatically wrap by calculating the width of text.`,table:{type:{summary:`number | string`},category:`General`}}}})),c,l,u,d;e((()=>{c=t(n()),a(),s(),l={argTypes:o,component:r},u={render:e=>c.createElement(i,{width:500,height:300},c.createElement(r,e,e.content)),args:{breakAll:!1,lineHeight:`1em`,maxLines:3,scaleToFit:!1,textAnchor:`start`,verticalAnchor:`start`,angle:0,width:200,y:50,x:50,content:`This is really, really, really, really, really, really, really, really, really long text`}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
...
}`,...u.parameters?.docs?.source}}},d=[`API`]}))();export{u as API,d as __namedExportsOrder,l as default};