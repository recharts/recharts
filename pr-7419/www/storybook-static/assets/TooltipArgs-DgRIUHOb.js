...
- If set to a function, the function will be called and should return HTML elements.`,table:{type:{summary:`Function | ReactNode`},category:`General`}},contentStyle:{description:"CSS styles to be applied to the wrapper `div` element.",table:{type:{summary:`React.CSSProperties`},category:`Style`,defaultValue:{summary:`{}`}},defaultValue:{}},cursor:{description:`If set false, no cursor will be drawn when tooltip is active.
...
If set "auto", the animation will be disabled in SSR and will respect the user's prefers-reduced-motion system preference for accessibility.`,table:{type:{summary:`"auto" | false | true`},category:`Animation`,defaultValue:{summary:`auto`}},defaultValue:`auto`},itemSorter:{description:"Sorts tooltip items.\nDefaults to 'name' which means it sorts alphabetically by graphical item `name` property.",table:{type:{summary:`"dataKey" | "name" | "value" | Function`},category:`General`,defaultValue:{summary:`name`}},defaultValue:`name`},itemStyle:{description:`CSS styles of individual items inside the tooltip, a \`<li>\` element.
...
and each of them gets this itemStyle applied.`,table:{type:{summary:`React.CSSProperties`},category:`Style`,defaultValue:{summary:`{}`}},defaultValue:{}},labelClassName:{control:{type:`text`},table:{type:{summary:`string`},category:`General`}},labelFormatter:{description:`The formatter function of label in tooltip.`,table:{type:{summary:`Function`},category:`General`}},labelStyle:{description:`CSS styles of the tooltip title.
...
where "labelStyle" are the individual items.`,table:{type:{summary:`React.CSSProperties`},category:`Style`,defaultValue:{summary:`{}`}},defaultValue:{}},offset:{description:`The offset size between the position of tooltip and the mouse cursor position.
