...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:`General`}}}})),y,b,x,S,C,w;e((()=>{y=t(n()),c(),d(),p(),v(),h(),b={argTypes:_,component:r},x={name:`Simple`,render:e=>{let{data:t,activeShape:n}=e;return y.createElement(o,{width:`100%`,height:400},y.createElement(r,e,y.createElement(l,{data:t,dataKey:`uv`,shape:({isActive:e,...t})=>y.createElement(u,{...t,fill:e?n.fill:t.fill})}),y.createElement(a,{defaultIndex:3})))},args:{...m(_),data:f,activeShape:{fill:`red`},margin:{top:0,right:0,bottom:0,left:0}}},S={render:e=>y.createElement(r,e,y.createElement(l,{data:e.data,dataKey:`uv`,nameKey:`name`,innerRadius:50,outerRadius:80,cornerRadius:8},y.createElement(i,{position:`center`,fill:`#000`,fontSize:12,fontWeight:`bold`,dy:-7},`Donut`),y.createElement(i,{position:`center`,fontSize:12,fontWeight:`bold`,dy:8},`Chart`),y.createElement(s,{align:`right`,verticalAlign:`middle`,layout:`vertical`}))),args:{...m(_),width:500,height:300,data:f}},C={render:e=>{let t=[{x:{value:1},name:`x1`,fill:`blue`},{x:{value:2},name:`x2`,fill:`red`},{x:{value:3},name:`x3`,fill:`green`}],n=[{y:{value:3},name:`y1`,fill:`blue`},{y:{value:2},name:`y2`,fill:`red`},{y:{value:1},name:`y3`,fill:`green`}],i=e=>(g(e.x),e.x.value),o=e=>(g(e.y),e.y.value),[c,u]=(0,y.useState)(!1),[d,f]=(0,y.useState)(!0);return y.createElement(y.Fragment,null,y.createElement(`button`,{type:`button`,onClick:()=>{u(!1),f(!0)}},`Use data1`),y.createElement(`button`,{type:`button`,onClick:()=>{u(!0),f(!0)}},`Use data2`),y.createElement(`button`,{type:`button`,onClick:()=>{f(!1)}},`Hide`),y.createElement(r,{...e,data:c?n:t},y.createElement(a,null),y.createElement(s,null),y.createElement(l,{data:c?n:t,name:`Animated line`,hide:!d,type:`monotone`,dataKey:c?o:i,stroke:`#8884d8`,strokeDasharray:`5 5`,label:{fill:`red`},animationDuration:3e3})))},args:{...m(_),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...C.parameters?.docs?.source}}},w=[`API`,`Donut`,`ChangingDataKey`]}))();export{x as API,C as ChangingDataKey,S as Donut,w as __namedExportsOrder,b as default};