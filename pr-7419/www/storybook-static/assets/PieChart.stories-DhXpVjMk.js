...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:`General`}}}})))()}var w,T,E,D,O,k;function A(){return(A=t((()=>{w=e(n()),d(),a(),p(),m(),i(),l(),s(),v(),y(),C(),T={argTypes:S,component:g},E={name:`Simple`,render:e=>{let{data:t,activeShape:n}=e;return w.createElement(r,{width:`100%`,height:400},w.createElement(g,e,w.createElement(h,{data:t,dataKey:`uv`,shape:({isActive:e,...t})=>w.createElement(u,{...t,fill:e?n.fill:t.fill})}),w.createElement(c,{defaultIndex:3})))},args:{...b(S),data:_,activeShape:{fill:`red`},margin:{top:0,right:0,bottom:0,left:0}}},D={render:e=>w.createElement(g,e,w.createElement(h,{data:e.data,dataKey:`uv`,nameKey:`name`,innerRadius:50,outerRadius:80,cornerRadius:8},w.createElement(f,{position:`center`,fill:`#000`,fontSize:12,fontWeight:`bold`,dy:-7},`Donut`),w.createElement(f,{position:`center`,fontSize:12,fontWeight:`bold`,dy:8},`Chart`),w.createElement(o,{align:`right`,verticalAlign:`middle`,layout:`vertical`}))),args:{...b(S),width:500,height:300,data:_}},O={render:e=>{let t=[{x:{value:1},name:`x1`,fill:`blue`},{x:{value:2},name:`x2`,fill:`red`},{x:{value:3},name:`x3`,fill:`green`}],n=[{y:{value:3},name:`y1`,fill:`blue`},{y:{value:2},name:`y2`,fill:`red`},{y:{value:1},name:`y3`,fill:`green`}],r=e=>(x(e.x),e.x.value),i=e=>(x(e.y),e.y.value),[a,s]=(0,w.useState)(!1),[l,u]=(0,w.useState)(!0);return w.createElement(w.Fragment,null,w.createElement(`button`,{type:`button`,onClick:()=>{s(!1),u(!0)}},`Use data1`),w.createElement(`button`,{type:`button`,onClick:()=>{s(!0),u(!0)}},`Use data2`),w.createElement(`button`,{type:`button`,onClick:()=>{u(!1)}},`Hide`),w.createElement(g,{...e,data:a?n:t},w.createElement(c,null),w.createElement(o,null),w.createElement(h,{data:a?n:t,name:`Animated line`,hide:!l,type:`monotone`,dataKey:a?i:r,stroke:`#8884d8`,strokeDasharray:`5 5`,label:{fill:`red`},animationDuration:3e3})))},args:{...b(S),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...O.parameters?.docs?.source}}},k=[`API`,`Donut`,`ChangingDataKey`]})))()}A();export{E as API,O as ChangingDataKey,D as Donut,k as __namedExportsOrder,T as default};