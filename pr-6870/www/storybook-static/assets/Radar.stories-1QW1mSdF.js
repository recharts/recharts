import{e}from"./iframe-C9kyXynm.js";import{g as i}from"./utils-ePvtT4un.js";import{A as c}from"./AnimationProps-CWko-cer.js";import{R as s}from"./Radar-C9K3K3VI.js";import{R as d}from"./arrayEqualityCheck-BdbBdFIu.js";import{R as m}from"./RadarChart-C4wmSM9v.js";import{P as p}from"./PolarGrid-TJGbLVWT.js";import{P as u}from"./PolarAngleAxis-BC8Gqo3a.js";import{P as f}from"./PolarRadiusAxis-D-S4QWcv.js";import{R as y}from"./RechartsHookInspector-CKajdCMN.js";import{s as h}from"./Page-DPte-9pC.js";const a={dataKey:{description:"The key of a group of data which should be unique in a radar chart.",table:{type:{summary:"string | number | Function"},category:"General"}},points:{description:"The coordinates of all the vertexes of the radar shape, like [{ x, y }].",table:{type:{summary:"Array"},category:"General"}},dot:{description:`If false set, dots will not be drawn. If true set, dots will be drawn which have
