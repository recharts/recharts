  ...
  return (
    ...
    >
      ...
      <Bar
        dataKey="pv"
        stackId="a"
        fill={focusedDataKey == null || focusedDataKey === 'pv' ? 'var(--color-chart-1)' : 'var(--color-solid-7)'}
      />
      <Bar
        dataKey="amt"
        stackId="a"
        fill={focusedDataKey == null || focusedDataKey === 'amt' ? 'var(--color-chart-2)' : 'var(--color-solid-7)'}
      />
      <Bar
        dataKey="uv"
        fill={focusedDataKey == null || focusedDataKey === 'uv' ? 'var(--color-chart-3)' : 'var(--color-solid-7)'}
      />
      <RechartsDevtools />
    </BarChart>
  );
