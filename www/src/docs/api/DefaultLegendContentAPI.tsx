...
export const DefaultLegendContentAPI: ApiDoc = {
  name: 'DefaultLegendContent',
  props: [
    {
      name: 'align',
    ...
    },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>
              DefaultLegendContent.payload is omitted from Legend props. A custom payload can be passed here if desired,
              or it can be passed from the Legend &quot;content&quot; callback.
            </p>
          </section>
        ),
      },
    },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>Vertical alignment of the whole Legend container:</p>
            <ul>
              <li>
  ...
  desc: {
    'en-US': (
      <section>
        <p>
          This component is by default rendered inside the <Link to="/api/Legend/">Legend</Link> component. You would
          not use it directly.
        </p>
        <p>
          You can use this component to customize the content of the legend, or you can provide your own completely
          independent content.
        </p>
      </section>
    ),
