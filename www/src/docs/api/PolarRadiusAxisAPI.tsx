  ...
  props: [
    ...
    },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>The angle of radial direction line to display axis text.</p>
          </section>
        ),
      },
      defaultVal: 0,
    ...
    { name: 'dangerouslySetInnerHTML', type: 'Object', isOptional: true },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>The key of data displayed in the axis</p>
          </section>
        ),
      },
    },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>
              Specify the domain of radius in a polar chart. And the length should be 2. And each element in the array
              can be a number, &#39;auto&#39;, &#39;dataMin&#39; or &#39;dataMax&#39;. If any element of domain is set
              to be &#39;auto&#39;, comprehensible scale ticks will be calculated, and the final domain of axis is
              generated by the ticks. If a function, receives &#39;[dataMin, dataMax]&#39;, and must return a computed
              domain as &#39;[min, max]&#39;.
            </p>
          </section>
        ),
    ...
    },
    {
      ...
      desc: {
        'en-US': (
          <section>
            <p>Consider hidden elements when computing the domain (defaults to false)</p>
          </section>
        ),
      },
      defaultVal: false,
        ...
        'en-US': (
          <section>
            ...
            <p>
              ...
              element, the option is the custom react element of drawing label. If set a function, the function will be
              called to render customized label.
            </p>
          </section>
        ),
      },
    ...
    { name: 'range', type: 'AxisRange', isOptional: true },
    {
      name: 'reversed',
      type: 'boolean',
      isOptional: true,
    ...
    {
      name: 'scale',
      type: '(union of 17 variants)',
      isOptional: true,
      desc: {
        'en-US': (
          <section>
            <p>If &#39;auto&#39; set, the scale function is linear scale.</p>
          </section>
        ),
      },
      defaultVal: 'auto',
