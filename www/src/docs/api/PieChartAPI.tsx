...
export const PieChartAPI: ApiDoc = {
  ...
  props: [
    ...
    { name: 'cx', type: 'string | number', isOptional: true, defaultVal: '50%' },
    { name: 'cy', type: 'string | number', isOptional: true, defaultVal: '50%' },
    {
      name: 'data',
      type: 'Array<any>',
      isOptional: true,
    ...
    { name: 'endAngle', type: 'number', isOptional: true, defaultVal: 360 },
    {
      name: 'height',
      type: 'number | `${number}%`',
      isOptional: true,
    ...
    { name: 'innerRadius', type: 'string | number', isOptional: true, defaultVal: 0 },
    { name: 'layout', type: '"centric" | "radial"', isOptional: true, defaultVal: 'centric' },
    {
      name: 'margin',
      type: 'Partial<Margin>',
      isOptional: true,
    ...
    { name: 'outerRadius', type: 'string | number', isOptional: true, defaultVal: '80%' },
    {
      name: 'responsive',
      type: 'boolean',
      isOptional: true,
    ...
    { name: 'startAngle', type: 'number', isOptional: true, defaultVal: 0 },
