...
import MinimapExample, { minimapExampleDefaultState, minimapExampleLevers } from './MinimapExample';
import minimapExampleSource from './MinimapExample?raw';
import ComposedInteractionsExample, {
  composedInteractionsExampleDefaultState,
  composedInteractionsExampleLevers,
} from './ComposedInteractionsExample';
...
import AutoScaleFollowExample, {
  autoScaleFollowExampleDefaultState,
  autoScaleFollowExampleLevers,
} from './AutoScaleFollowExample';
...
import BrushZoomModeExample, {
  brushZoomModeExampleDefaultState,
  brushZoomModeExampleLevers,
} from './BrushZoomModeExample';
...
{ x: { start: 0.66, end: 1 } }`}</pre>
      ...
      <CodeEditorWithPreview
        ...
        defaultControlsState={minimapExampleDefaultState}
        levers={minimapExampleLevers}
      ...
      <p>
        ...
        you explicitly switch it to <code>mode=&quot;zoom&quot;</code>. Here exactly five interactions are mounted -
        wheel, drag-to-pan, axis bands, double-click reset and an x-axis scrollbar - and nothing else (no pinch, no
        keyboard):
      </p>
      <CodeEditorWithPreview
        Component={ComposedInteractionsExample}
        defaultControlsState={composedInteractionsExampleDefaultState}
        levers={composedInteractionsExampleLevers}
      ...
      <table className={styles.table}>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              When the chart is focused: <code>+</code>/<code>-</code> zoom, <code>Shift</code>+arrows pan,{' '}
              <code>0</code>/<code>Esc</code> reset. Unmodified arrows keep navigating data points.
            </td>
          </tr>
          <tr>
            <td>
...
<ZoomAndPan viewport={viewport} onZoomChange={setViewport} />`}</pre>
      ...
      <CodeEditorWithPreview
        ...
        defaultControlsState={autoScaleFollowExampleDefaultState}
        levers={autoScaleFollowExampleLevers}
      ...
      <CodeEditorWithPreview
        ...
        defaultControlsState={brushZoomModeExampleDefaultState}
        levers={brushZoomModeExampleLevers}
      ...
      <p>
        ...
        reset. Double-tap-then-drag is disabled by default; set <code>doubleTapDrag=&quot;zoom&quot;</code> for the
        &quot;maps&quot; gesture, or <code>doubleTapDrag=&quot;select&quot;</code> to select a window.
      </p>
      <p>
