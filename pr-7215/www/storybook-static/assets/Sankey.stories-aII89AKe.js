...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},un={argTypes:$,component:C},I={name:"Simple",render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:R,...e},f.createElement(ze,null),f.createElement(B,null))),args:{...O($),data:R}},M={render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:R,...e},f.createElement(B,null))),args:{...O($),data:R,nodeWidth:10,nodePadding:60,height:500,width:960}},j={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],s=n=>f.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),o=n=>f.createElement("g",null,f.createElement("path",{d:`
...
}`,...(ce=(ue=M.parameters)==null?void 0:ue.docs)==null?void 0:ce.source}}};var de,me,he;j.parameters={...j.parameters,docs:{...(de=j.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: (args: Args) => {
...
}`,...(he=(me=j.parameters)==null?void 0:me.docs)==null?void 0:he.source}}};const cn=["API","Customized","CustomNodeAndLink"];export{I as API,j as CustomNodeAndLink,M as Customized,cn as __namedExportsOrder,un as default};
