...
Call log:
  ...
  - 43208 pixels (ratio 0.25 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 40808 pixels (ratio 0.23 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 1088 pixels (ratio 0.01 of all image pixels) are different.
