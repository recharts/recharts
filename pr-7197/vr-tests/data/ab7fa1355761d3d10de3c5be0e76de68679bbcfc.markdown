...
Call log:
  ...
  - 43659 pixels (ratio 0.25 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 36267 pixels (ratio 0.21 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 5888 pixels (ratio 0.04 of all image pixels) are different.
