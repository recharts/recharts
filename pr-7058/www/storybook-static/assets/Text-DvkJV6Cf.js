...
@defaultValue false`,name:"breakAll",required:!1,type:{name:"boolean"}}}}}catch{}try{W.displayName="Text",W.__docgenInfo={description:"",displayName:"Text",props:{lineHeight:{defaultValue:null,description:`Line height for multi-line text.
...
**Interaction with other props:**
- When \`scaleToFit\` is true, this property is ignored
- Requires \`width\` to be set for line breaking to occur`,name:"maxLines",required:!1,type:{name:"number"}},textAnchor:{defaultValue:null,description:`Horizontal text alignment within the text element.
