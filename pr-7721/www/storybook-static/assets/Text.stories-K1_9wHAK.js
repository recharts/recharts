import{R as n}from"./iframe-CQz631Nk.js";import{T as s}from"./Text-CpmwLb5H.js";import{S as l}from"./isWellBehavedNumber-B7MN_LAX.js";import"./preload-helper-Dp1pzeXC.js";import"./get-C2VjdU0L.js";import"./resolveDefaultProps-BsWR9NdC.js";import"./DOMUtils-V3cEDC71.js";import"./useId-BSAAHf1D.js";import"./useBackwardsCompatibleTheme-DhqH6-Ub.js";const o={angle:{description:`Text rotation angle in degrees.
...
Ignored when \`textPath\` is set because the path controls the text's positioning.`,control:{type:"select"},options:["end","middle","start"],table:{type:{summary:'"end" | "middle" | "start"'},category:"General",defaultValue:{summary:"end"}},defaultValue:"end"},width:{description:"When width is specified, the text will automatically wrap by calculating the width of text.\nWhen `textPath` is set, this prop does not wrap or constrain the path text; it only affects scaling when `scaleToFit` is enabled.",table:{type:{summary:"number | string"},category:"General"}}},g={argTypes:o,component:s},e={render:t=>n.createElement(l,{width:500,height:300},n.createElement(s,{...t},t.content)),args:{breakAll:!1,lineHeight:"1em",maxLines:3,scaleToFit:!1,textAnchor:"start",verticalAnchor:"start",angle:0,width:200,y:50,x:50,content:"This is really, really, really, really, really, really, really, really, really long text"}};var a,r,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
...
}`,...(i=(r=e.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const b=["API"];export{e as API,b as __namedExportsOrder,g as default};
