...
- Location: test-vr/tests/LabelList.spec-vr.tsx:18:15
...
Locator: locator('#root').locator(':scope > *').first()
  219076 pixels (ratio 0.49 of all image pixels) are different.
...
Call log:
  ...
  - 223368 pixels (ratio 0.50 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6926 pixels (ratio 0.02 of all image pixels) are different.
