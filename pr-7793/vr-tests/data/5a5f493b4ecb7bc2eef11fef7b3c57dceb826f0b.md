...
- Location: test-vr/tests/LabelList.spec-vr.tsx:58:15
...
Call log:
  ...
  - 223609 pixels (ratio 0.50 of all image pixels) are different.
  ...
  - attempting scroll into view action
    - waiting for element to be stable
  - 6022 pixels (ratio 0.02 of all image pixels) are different.
