...
export const treeshakingGroups: Record<string, ReadonlyArray<string>> = {
  ...
  CartesianGrid,
  ComposedChart,
  Curve: ['useChartLayout'],
  Customized,
  DefaultLegendContent: ['DefaultLegendContent', 'Surface', 'Symbols'],
  ErrorBar,
  Funnel,
  FunnelChart,
  Label: ['DefaultZIndexes', 'Global', 'Label', 'Text', 'ZIndexLayer', 'useChartLayout'],
  ...
  RadialBar,
  RadialBarChart,
  Rectangle: ['Global', 'interpolate', 'Rectangle'],
  ReferenceArea,
  ReferenceDot,
  ReferenceLine,
  Sankey,
  ...
  Text: ['Global', 'Text'],
  Tooltip,
  Trapezoid: ['Global', 'interpolate', 'Trapezoid'],
  Treemap,
  XAxis,
  YAxis,
  ZAxis,
  useCartesianChartLayout: ['useChartLayout'],
  ...
  ZIndexLayer: ['DefaultZIndexes', 'ZIndexLayer', 'useChartLayout'],
  createVerticalChart: [
    'AreaChart',
    'BarChart',
    'ComposedChart',
