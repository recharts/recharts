import{e}from"./iframe-DmHHE4lP.js";import{g as m}from"./utils-ePvtT4un.js";import{C}from"./ComposedChart-6GwosE_U.js";import{t as O}from"./Time-CZh6Vidc.js";import{A as p}from"./Area-C9L46kbX.js";import{B as a}from"./Bar-C6ldBGSs.js";import{L as d}from"./Line-DOsGA7cb.js";import{R as D}from"./arrayEqualityCheck-t0Foyoao.js";import{R}from"./RechartsHookInspector-BtHYkDer.js";import{X as u}from"./XAxis-DgoG7wOz.js";import{Y as y}from"./YAxis-7nE9-RZi.js";import{L as h}from"./Legend-Cde7TLMz.js";import{C as f}from"./CartesianGrid-APnkO6Yx.js";import{R as j}from"./ReferenceLine-ClXnfY4Q.js";import{R as H}from"./ReferenceDot-I52aIxch.js";import{B as I}from"./Brush-BuDAkM_Z.js";import{L as X}from"./LineChart-Wucdo_lL.js";import{T as g}from"./Tooltip-uUUOr1QD.js";import{S as Y}from"./Scatter-BjECKBdK.js";import{p as r}from"./Page-DPte-9pC.js";const n={accessibilityLayer:{description:"Turn on accessibility support for keyboard-only and screen reader users.",control:{type:"boolean"},table:{type:{summary:"boolean"},category:"General",defaultValue:{summary:"true"}},defaultValue:!0},barCategoryGap:{description:"The gap between two bar categories, which can be a percent value or a fixed value.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"10%"}},defaultValue:"10%"},barGap:{description:"The gap between two bars in the same category.",table:{type:{summary:"number | string"},category:"General",defaultValue:{summary:"4"}},defaultValue:4},barSize:{description:`The width or height of each bar. If the barSize is not specified, the size of the
