 ...
 */
export const BarStackWithStrokedBarsAndRoundedCorners = () => {
  return (
 ...
 */
export const BarStackWithStrokedBarsAndSquareCorners = () => {
  return (
    <BarChart width={500} height={300} data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
      <CartesianGrid strokeDasharray="3 3" />
      <XAxis dataKey="name" />
 ...
 */
export const BarStackWithRoundedCornersAndNoStroke = () => {
  return (
    <BarChart width={500} height={300} data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
      <CartesianGrid strokeDasharray="3 3" />
      <XAxis dataKey="name" />
