...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},I={argTypes:u,component:s},a={name:"Simple",render:t=>{const{data:o,activeShape:i}=t;return e.createElement(P,{width:"100%",height:400},e.createElement(s,{...t},e.createElement(p,{data:o,dataKey:"uv",shape:({isActive:c,...l})=>e.createElement(F,{...l,fill:c?i.fill:l.fill})}),e.createElement(z,{defaultIndex:3}),e.createElement(g,null)))},args:{...y(u),data:k,activeShape:{fill:"red"},margin:{top:0,right:0,bottom:0,left:0}}},r={render:t=>e.createElement(s,{...t},e.createElement(p,{data:t.data,dataKey:"uv",nameKey:"name",innerRadius:50,outerRadius:80,cornerRadius:8},e.createElement(v,{position:"center",fill:"#000",fontSize:12,fontWeight:"bold",dy:-7},"Donut"),e.createElement(v,{position:"center",fontSize:12,fontWeight:"bold",dy:8},"Chart"),e.createElement(D,{align:"right",verticalAlign:"middle",layout:"vertical"})),e.createElement(g,null)),args:{...y(u),width:500,height:300,data:k}},n={render:t=>{const o=[{x:{value:1},name:"x1",fill:"blue"},{x:{value:2},name:"x2",fill:"red"},{x:{value:3},name:"x3",fill:"green"}],i=[{y:{value:3},name:"y1",fill:"blue"},{y:{value:2},name:"y2",fill:"red"},{y:{value:1},name:"y3",fill:"green"}],c=h=>h.x.value,l=h=>h.y.value,[d,b]=f.useState(!1),[R,m]=f.useState(!0);return e.createElement(e.Fragment,null,e.createElement("button",{type:"button",onClick:()=>{b(!1),m(!0)}},"Use data1"),e.createElement("button",{type:"button",onClick:()=>{b(!0),m(!0)}},"Use data2"),e.createElement("button",{type:"button",onClick:()=>{m(!1)}},"Hide"),e.createElement(s,{...t,data:d?i:o},e.createElement(z,null),e.createElement(D,null),e.createElement(g,null),e.createElement(p,{data:d?i:o,name:"Animated line",hide:!R,type:"monotone",dataKey:d?l:c,stroke:"#8884d8",strokeDasharray:"5 5",label:{fill:"red"},animationDuration:3e3})))},args:{...y(u),width:500,height:300,margin:{top:30,right:30,left:20,bottom:5}}};var C,x,w;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Simple',
...
}`,...(w=(x=a.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var E,S,T;r.parameters={...r.parameters,docs:{...(E=r.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
...
}`,...(T=(S=r.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var V,G,A;n.parameters={...n.parameters,docs:{...(V=n.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: (args: Record<string, any>) => {
    const data1 = [{
      x: {
        value: 1
...
}`,...(A=(G=n.parameters)==null?void 0:G.docs)==null?void 0:A.source}}};const K=["API","Donut","ChangingDataKey"],N=Object.freeze(Object.defineProperty({__proto__:null,API:a,ChangingDataKey:n,Donut:r,__namedExportsOrder:K,default:I},Symbol.toStringTag,{value:"Module"}));export{a as A,N as C};
