...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},x={argTypes:i,component:l},r={name:"Simple",render:a=>{const{data:t}=a;return e.createElement(E,{width:"100%",height:200},e.createElement(l,{accessibilityLayer:!0,data:t},e.createElement(p,{dataKey:"value",stroke:"#424242",isAnimationActive:!0,lastShapeType:"rectangle",shape:a.shape,activeShape:a.activeShape},e.createElement(C,{dataKey:"name",fill:"#000",position:"right",stroke:"none"})),e.createElement(g,null),e.createElement(f,null)))},args:{...y(i),shape:{},activeShape:{fill:"gold",stroke:"purple"},data:[{fill:"#EEEEEE",name:"A",value:1009},{fill:"#E0E0E0",name:"B",value:903},{fill:"#BDBDBD",name:"C",value:756},{fill:"#9E9E9E",name:"D",value:622},{fill:"#757575",name:"E",value:602},{fill:"#424242",name:"F",value:580},{fill:"#424242",name:"F",value:580}]}},n={render:a=>{const[t,b]=e.useState("amt");return e.createElement(e.Fragment,null,e.createElement("form",{style:{display:"flex",flexDirection:"column"},onChange:o=>"value"in o.target&&typeof o.target.value=="string"&&b(o.target.value)},e.createElement("label",{htmlFor:"dataKey-amt",style:{display:"flex",flexDirection:"row"}},e.createElement("input",{type:"radio",id:"dataKey-amt",name:"dataKey",value:"amt",defaultChecked:t==="amt"}),"dataKey 1"),e.createElement("label",{htmlFor:"dataKey-pv",style:{display:"flex",flexDirection:"row"}},e.createElement("input",{type:"radio",id:"dataKey-pv",name:"dataKey",value:"pv",defaultChecked:t==="pv"}),"dataKey 2"),e.createElement("label",{htmlFor:"dataKey-empty",style:{display:"flex",flexDirection:"row"}},e.createElement("input",{type:"radio",id:"dataKey-empty",name:"dataKey",value:"hidden",defaultChecked:t==="hidden"}),"Hidden")),e.createElement(l,{...a},e.createElement(w,null),e.createElement(p,{dataKey:t,fill:"orange",fillOpacity:.5,stroke:"blue",strokeDasharray:"3 3",lastShapeType:"rectangle",label:{dataKey:"name",stroke:"none",fill:"black",strokeDasharray:"0 0"}}),e.createElement(g,null),e.createElement(f,null)))},args:{...y(i),data:v,width:360,height:360}};var s,c,u;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: 'Simple',
  render: (args: Args) => {
    const {
      data
...
}`,...(h=(d=n.parameters)==null?void 0:d.docs)==null?void 0:h.source}}};const F=["API","WithChangingDataKey"],I=Object.freeze(Object.defineProperty({__proto__:null,API:r,WithChangingDataKey:n,__namedExportsOrder:F,default:x},Symbol.toStringTag,{value:"Module"}));export{r as A,I as C};
