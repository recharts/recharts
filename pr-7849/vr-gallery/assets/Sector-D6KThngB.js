import{r as V}from"./entry-C-njSPyf.js";import{r as W,c as j,t as k,f as q,v as M,p as E}from"./useId-D80Rnv8s.js";import{p as g,aV as x}from"./renderedTicksSlice-DqJbibzX.js";const w=(n,$)=>{const s=E($-n),a=Math.min(Math.abs($-n),359.999);return s*a},P=({cx:n,cy:$,radius:s,angle:a,sign:t,isExternal:p,cornerRadius:l,cornerIsExternal:o})=>{const c=l*(p?1:-1)+s,e=Math.asin(l/c)/x,h=o?a:a+t*e,i=g(n,$,c,h),r=g(n,$,s,h),f=o?a-t*e:a,y=g(n,$,c*Math.cos(e*x),f);return{center:i,circleTangency:r,lineTangency:y,theta:e}},A=({cx:n,cy:$,innerRadius:s,outerRadius:a,startAngle:t,endAngle:p})=>{const l=w(t,p),o=t+l,c=g(n,$,a,t),e=g(n,$,a,o);let h=M`M ${c.x},${c.y}
    A ${a},${a},0,
    ${+(Math.abs(l)>180)},${+(t>o)},
    ${e.x},${e.y}
