import{a as V}from"./lightTheme-lBxNBN17.js";import{r as W,c as j,t as k,f as q,v as M,o as E}from"./useId-pVXaFXcV.js";import{V as g,b1 as x}from"./renderedTicksSlice-Cgnul669.js";const w=(n,$)=>{const s=E($-n),a=Math.min(Math.abs($-n),359.999);return s*a},b=({cx:n,cy:$,radius:s,angle:a,sign:t,isExternal:f,cornerRadius:l,cornerIsExternal:o})=>{const c=l*(f?1:-1)+s,e=Math.asin(l/c)/x,h=o?a:a+t*e,i=g(n,$,c,h),p=g(n,$,s,h),r=o?a-t*e:a,y=g(n,$,c*Math.cos(e*x),r);return{center:i,circleTangency:p,lineTangency:y,theta:e}},A=({cx:n,cy:$,innerRadius:s,outerRadius:a,startAngle:t,endAngle:f})=>{const l=w(t,f),o=t+l,c=g(n,$,a,t),e=g(n,$,a,o);let h=M`M ${c.x},${c.y}
    A ${a},${a},0,
    ${+(Math.abs(l)>180)},${+(t>o)},
    ${e.x},${e.y}
