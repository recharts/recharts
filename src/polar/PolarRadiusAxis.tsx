...
export interface PolarRadiusAxisProps
  extends Omit<BaseAxisProps, 'scale' | 'domain' | 'allowDuplicatedCategory' | 'type'>, ZIndexable {
  /**
  ...
  /**
   * Specify the domain of radius in a polar chart. And the length should be 2.
   * And each element in the array can be a number, 'auto', 'dataMin' or 'dataMax'.
   * If any element of domain is set to be 'auto', comprehensible scale ticks will be calculated, and the final domain of axis is generated by the ticks.
   * If a function, receives '[dataMin, dataMax]', and must return a computed domain as '[min, max]'.
   *
   * @example <PolarRadiusAxis domain={['dataMin', 'dataMax']} />
   * @example <PolarRadiusAxis domain={[0, 'dataMax']} />
   * @example <PolarRadiusAxis domain={['auto', 'auto']} />
   * @example <PolarRadiusAxis domain={([dataMin, dataMax]) => { const absMax = Math.max(Math.abs(dataMin), Math.abs(dataMax)); return [-absMax, absMax]; }} />
   */
  domain?: AxisDomain;
  /**
  ...
  /**
   * If 'auto' set, the scale function is linear scale.
   * @defaultValue auto
