      ...
      {sectors.map((entry: PieSectorDataItem, i: number) => {
        ...
        return (
          <Layer
            ...
            onFocus={(event: React.FocusEvent<SVGPathElement>) => onMouseEnterFromContext(entry, i)(event as any)}
            onBlur={(event: React.FocusEvent<SVGPathElement>) => onMouseLeaveFromContext(entry, i)(event as any)}
