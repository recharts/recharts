...
type SelectionStyleProps = {
  /** Class added to the drag selection rectangle (the `.recharts-zoom-selection` class is always present). */
  selectionClassName?: string;
  /** Inline style merged onto the drag selection rectangle. */
...
export type DragToSelectProps = CommonZoomProps &
  ...
  SelectionStyleProps & {
    /**
     * Called when a drag selection completes, with the selected window per axis in `[0, 1]` fractions of the
