 ...
 * - `0` / `Escape` reset,
 * - <kbd>Shift</kbd> + arrow keys pan.
 *
 * Unmodified arrows are reserved for the chart's accessibility data-point navigation.
 */
  ...
  const onKeyDown = (event: KeyboardEvent) => {
    ...
    switch (event.key) {
      ...
      case 'ArrowDown': {
        ...
        const dist = options.panStep * options.panFastMultiplier;
