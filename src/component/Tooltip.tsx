...
> & {
   ...
   *
   * @example <Tooltip formatter={(value) => new Intl.NumberFormat('ar', { numberingSystem: 'arab' }).format(value)} />
   */
  formatter?: (
    value: TValue,
    name: TName,
   ...
   *
   * @example <Tooltip labelFormatter={(label) => new Intl.NumberFormat('ar', { numberingSystem: 'arab' }).format(label)} />
   */
