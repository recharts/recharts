...
export class CartesianAxis extends Component<Props, IState> {
   ...
   * @param {String} fontSize The fontSize to use when calculating size of ticks
   * @param {String} letterSpacing The letterSpacing to use when calculating size of ticks
