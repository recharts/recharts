...
import { BaseAxisMap, BaseAxisProps, CartesianViewBox, ChartOffset, Margin, XAxisMap, YAxisMap } from '../util/types';
...
export const PolarAngleAxisContext = createContext<BaseAxisMap | undefined>(undefined);
export const PolarRadiusAxisContext = createContext<BaseAxisMap | undefined>(undefined);
 ...
 * @returns axis configuration object, or undefined
 */
export const useMaybePolarAngleAxis = (axisId: string | number): BaseAxisProps | undefined => {
 ...
 * @returns axis configuration object, or undefined
 */
export const useMaybePolarRadiusAxis = (axisId: string | number): BaseAxisProps | undefined => {
