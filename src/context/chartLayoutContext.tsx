 ...
 */
export const useXAxisOrThrow = (xAxisId: string | number): XAxisWithExtraData => {
  ...
  const xAxis: XAxisWithExtraData | undefined = xAxisMap[xAxisId];
 ...
 */
export const useMaybeXAxis = (xAxisId: string | number): XAxisWithExtraData | undefined => {
  const xAxisMap = useAppSelector(selectXAxisMap);
 ...
 */
export const useArbitraryYAxis = (): YAxisWithExtraData | undefined => useAppSelector(selectArbitraryYAxis);
 ...
 * @throws Error if no axis with this ID exists
 */
export const useYAxisOrThrow = (yAxisId: string | number): YAxisWithExtraData => {
  const yAxisMap = useAppSelector(selectYAxisMap);
  ...
  const yAxis: YAxisWithExtraData | undefined = yAxisMap[yAxisId];
 ...
 * @returns axis configuration object, or undefined
 */
export const useMaybeYAxis = (yAxisId: string | number): YAxisWithExtraData | undefined => {
  const yAxisMap = useAppSelector(selectYAxisMap);
