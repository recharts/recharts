...
describe('<Area />', () => {
  ...
  it('Render customized label when label is set to be a function', () => {
    ...
    const wrapper = render(
      <Surface width={500} height={500}>
        <Area isAnimationActive={false} baseLine={200} points={data} label={renderLabel} />
      </Surface>,
    );
  ...
  it('Render customized label when label is set to be a react element', () => {
    ...
    const wrapper = render(
      <Surface width={500} height={500}>
        <Area isAnimationActive={false} baseLine={200} points={data} label={<Label />} />
      </Surface>,
    );
  ...
  it('Render customized dot when dot is set to be a function', () => {
    ...
    const wrapper = render(
      <Surface width={500} height={500}>
        <Area isAnimationActive={false} baseLine={200} points={data} dot={renderDot} />
      </Surface>,
    );
  ...
  it('Render customized label when label is set to be a react element', () => {
    ...
    const wrapper = render(
      <Surface width={500} height={500}>
        <Area isAnimationActive={false} baseLine={200} points={data} dot={<CustomizedDot />} />
      </Surface>,
    );
  ...
  it('renders the curve with the stroke on top (2nd) of the curve with the fill (1st)', () => {
    const wrapper = mount(
      <Surface width={500} height={500}>
        <Area points={data} baseLine={200} stroke="teal" fill="teal" />
      </Surface>,
    );
