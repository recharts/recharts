...
describe('<Brush />', () => {
  ...
  it('Render 2 travellers and 1 slide in simple Brush', () => {
    const wrapper = render(<Brush x={100} y={50} width={400} height={40} data={data} />);
  ...
  it("Don't render any travellers or slide when data is empty in simple Brush", () => {
    const wrapper = render(<Brush x={100} y={50} width={400} height={40} data={[]} />);
  ...
  it('mouse enter and mouse leave on traveller will set isTextActive true', () => {
    const wrapper = mount(<Brush x={100} y={50} width={400} height={40} data={data} />);
  ...
  it('render text when alwaysShowText is true', () => {
    const wrapper = mount(<Brush x={100} y={50} width={400} height={40} data={data} alwaysShowText />);
