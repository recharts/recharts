...
describe('<Scatter />', () => {
  ...
  it('Render customized symbols when shape is set to be a ReactElement', () => {
    const CustomizedShape = ({ cx, cy }) => <circle cx={cx} cy={cy} r={5} className="customized-shape" />;
    const wrapper = render(
      <Surface width={500} height={500}>
        <Scatter isAnimationActive={false} shape={<CustomizedShape />} points={data} />
      </Surface>,
    );
  ...
  it('Render customized symbols when shape is set to be a function', () => {
    const renderCustomizedShape = ({ cx, cy }) => <circle cx={cx} cy={cy} r={5} className="customized-shape" />;
    const wrapper = render(
      <Surface width={500} height={500}>
        <Scatter isAnimationActive={false} shape={renderCustomizedShape} points={data} />
      </Surface>,
    );
  ...
  it('Render customized line when line is set to be a ReactElement', () => {
    const CustomizedLine = ({ points }) => <path d="M0,0L200,200" className="customized-line" />;
    const wrapper = render(
      <Surface width={500} height={500}>
        <Scatter isAnimationActive={false} line={<CustomizedLine />} points={data} />
      </Surface>,
    );
  ...
  it('Render customized line when line is set to be a function', () => {
    const renderCustomizedLine = ({ points }) => <path d="M0,0L200,200" className="customized-line" />;
    const wrapper = render(
      <Surface width={500} height={500}>
        <Scatter isAnimationActive={false} line={renderCustomizedLine} points={data} />
      </Surface>,
    );
  ...
  it('mouse enter or mouse leave a symbol', () => {
    const wrapper = mount(
      <Surface width={500} height={500}>
        <Scatter isAnimationActive={false} points={data} />
      </Surface>,
    );
