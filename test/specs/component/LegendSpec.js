...
describe('<Legend />', () => {
  ...
  it('Render 4 legend items in simple Legend', () => {
    const wrapper = render(<Legend width={500} height={30} payload={data} />);
  ...
  it('Render customized legend when content is set to be a react element', () => {
    ...
    const wrapper = render(<Legend width={500} height={30} payload={data} content={<CustomizedLegend />} />);
  ...
  it('Does not render items with a type of `none`', () => {
    ...
    const wrapper = render(<Legend width={500} height={30} payload={dataWithNone} />);
