...
describe('<ResponsiveContainer />', () => {
  ...
  it('should pass data-testid when using fixed width and height', () => {
    render(
      <ResponsiveContainer width={400} height={300} data-testid="fixed-container">
        <DimensionSpy />
      </ResponsiveContainer>,
    );

    expect(screen.getByTestId('fixed-container')).toBeInTheDocument();
  });
});
