...
describe('<Treemap />', () => {
  ...
  test('uses the same drawing height for nest layout and surface', () => {
    ...
    expect(depth0Rect.getAttribute('height')).toBe(String(chartHeight - 30 - 1));
  });
