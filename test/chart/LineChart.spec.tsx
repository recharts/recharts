...
describe('<LineChart /> - Rendering two line charts with syncId', () => {
  ...
  // TODO tooltip sync somehow doesn't activate the correct active dots - investigate and fix
  test.fails(
    'should show tooltips for both charts synced by index on MouseEnter and hide on MouseLeave/Escape',
    async () => {
  ...
  // TODO tooltip sync somehow doesn't activate the correct tooltips - investigate and fix
  test.fails(
    "should show tooltips using syncMethod: 'value' for both charts on MouseEnter and hide on MouseLeave",
    async () => {
      const chart1 = (
