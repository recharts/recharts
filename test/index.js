//chart
let AreaSpec = require('./specs/chart/AreaSpec.js');
let BarSpec = require('./specs/chart/BarSpec.js');
let LineSpec = require('./specs/chart/LineSpec.js');
let PieSpec = require('./specs/chart/PieSpec.js');
let RadarSecondSpec = require('./specs/chart/RadarSecondSpec.js');
let RadarSpec = require('./specs/chart/RadarSpec.js');
let RadialBarSpec = require('./specs/chart/RadialBarSpec.js');
let ScatterSpec = require('./specs/chart/ScatterSpec.js');
...
let CartesianAxisSpec = require('./specs/component/CartesianAxisSpec.js');
let CartesianGridSpec = require('./specs/component/CartesianGridSpec.js');
let DefaultTooltipContentSpec = require('./specs/component/DefaultTooltipContentSpec.js');
let LegendSpec = require('./specs/component/LegendSpec.js');
let PolarAngleAxisSpec = require('./specs/component/PolarAngleAxisSpec.js');
let PolarGridSpec = require('./specs/component/PolarGridSpec.js');
let PolarRadiusAxisSpec = require('./specs/component/PolarRadiusAxisSpec.js');
...
let DotSpec = require('./specs/shape/DotSpec.js');
