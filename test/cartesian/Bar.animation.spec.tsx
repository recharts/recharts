  ...
  describe('shape prop', () => {
    ...
    const renderShapeTestCase = createSelectorTestCase(({ children }: { children?: ReactNode }) => (
      <BarChart width={100} height={100} data={smallerData}>
        ...
        <Bar dataKey="pv" isAnimationActive animationEasing="linear" shape={CustomShape} />
        {children}
      </BarChart>
    ));
    ...
    it('should pass t, isAnimating, isEntrance props to custom shape', async () => {
      ...
      const shapeDuringAnimation = container.querySelector('.custom-bar-shape');
      ...
      await animationManager.completeAnimation();
      const shapeAfterAnimation = container.querySelector('.custom-bar-shape');
