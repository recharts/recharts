...
describe('getTicksForAxis', () => {
  ...
  it('Works for xAxis - THIS IS THE BUG. The output does not even suffice the type definition.', () => {
    expect(getTicksOfAxis(X_AXIS_EXAMPLE, true, undefined)).toEqual([
      {
        coordinate: NaN,
        offset: 0,
        value: [
