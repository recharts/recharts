...
Can be a number or a percent string like "100%".`,table:{type:{summary:"`${number}%` | number"},category:"General"}}},wt={argTypes:$,component:C},N={name:"Simple",render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:P,...e},f.createElement(ze,null),f.createElement(_,null))),args:{...O($),data:P}},V={render:e=>f.createElement(Y,{width:"100%",height:400},f.createElement(C,{data:P,...e},f.createElement(_,null))),args:{...O($),data:P,nodeWidth:10,nodePadding:60,height:500,width:960}},T={render:e=>{const t=["#3C898E","#486DF0","#6F50E5"],i=n=>f.createElement("rect",{x:n.x+4,y:n.y-2,width:n.width-8,height:n.height+4,fill:t[n.payload.depth%t.length],rx:2.5}),o=n=>f.createElement("g",null,f.createElement("path",{d:`
